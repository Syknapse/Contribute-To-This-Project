...
> ## **Announcement:**
>
> Anda ingin menjadi maintainer pada proyek ini dan membantu menjaga terus berjalan? Jika tertarik, baca [panduan maintainer](/maintainer_guide.md), bergabung ke [server Discord kami](https://discord.gg/tWkvS4ueVF), dan minta untuk bergabung dengan tim dari para maintainer.
>
...
- [Pengantar](#pengantar)
- [Tujuan](#tujuan)
- [Siapa yang ini adalah?](#siapa-yang-ini-adalah)
- [Mengapa saya perlu melakukan ini?](#mengapa-saya-perlu-melakukan-ini)
- [Apa yang saya akan kontribusikan?](#apa-yang-saya-akan-kontribusikan)
...
- [Contribute](#contribute)
  ...
  - [Step 9: Submit a PR (Pull Request)](#step-9-submit-a-pr-pull-request)
...
> [!Note]
> This tutorial is based on GitHub Desktop. [If you're comfortable with the terminal go to this tutorial (Click Here)](/terminal_tutorial.md)

First let's get set up to do the work.
...
- Now you have created a new branch separate from master.
...
- The project has a ready-made card template waiting for you in the `cards/` folder.
- Find the project folder on your computer. If you kept the default path this will be something like `your-computer > Documents > GitHub > Contribute-To-This-Project > cards`.
...
- Your card file looks like this:
...
- Replace `Your name` with your name. **Do not change `class="name"`**.
- Replace the GitHub link and handle with your own. You can add more contact links if you like — go to [Font Awesome Icons](https://fontawesome.com/icons) and search for the right icon (e.g. `fab fa-linkedin`, `fab fa-x-twitter`). Same pattern, just swap the class.
- Replace `Write a sentence or two about yourself` with a short description. Think of it more like a tweet than a blog post.
- For each resource, replace `#` with a real link, add a short description in `title=""`, and replace the link text. Share anything useful to web developers — a video, a talk, a podcast, an article, a tool. If you are a beginner don't be put off by this, share whatever you know even if you think it's basic. You'll be surprised how many people will benefit.
  - **Link:** `href="https://the-real-url.com"` — use the full URL, no shorteners.
  - **Title:** `title="Brief description"` — a few words is enough.
  - **Name:** The text between the tags `>Name of resource</a>`.

- Make sure you have **saved all your changes**.

- **Note: Don't change any class names or the structure of the HTML.** The bot that validates your PR checks for these.
...
- Open your card file and read through it. Make sure all the placeholder text is gone, all your links start with `https://`, and nothing looks obviously wrong.
- It is also good practice to test your links by opening them in a browser to confirm they work and go where you expect.
- That is all the testing you need to do. The automated check when you submit your PR will catch anything structural you might have missed.
...
- Now a _Pull Request_ will be sent to the project. A bot will automatically check your card and, if everything looks good, merge it for you. You will get a GitHub notification when it is done.
