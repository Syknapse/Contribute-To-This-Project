# [Ka Qayb Qaado Mashruucan](https://syknapse.github.io/Contribute-To-This-Project/)
...
- [Yaa loogu talagalay?](#yaa-loogu-talagalay)
- [Maxaan uga baahnahay inaan tan sameeyo?](#maxaan-uga-baahnahay-inaan-tan-sameeyo)
- [Maxaan ku kordhinayaa (contribute)?](#maxaan-ku-kordhinayaa-contribute)
- [Turjumaadaha](#turjumaadaha)
- [Setup! :)](#setup-)
- [Ka Qayb Qaado](#ka-qayb-qaado)
  - [Tallaabada 1: Fork-garee kaydkan (repository)](#tallaabada-1-fork-garee-kaydkan-repository)
  - [Tallaabada 2: Clone-garee kaydka](#tallaabada-2-clone-garee-kaydka)
  - [Tallaabada 3: Samee farac (branch) cusub](#tallaabada-3-samee-farac-branch-cusub)
  - [Tallaabada 4: Fur faylka index.html](#tallaabada-4-fur-faylka-indexhtml)
  - [Tallaabada 5: copy ka samee template-ka kaadhka](#tallaabada-5-copy-ka-samee-template-ka-kaadhka)
  - [Tallaabada 6: Codso isbeddelladaada](#tallaabada-6-codso-isbeddelladaada)
  - [Tallaabada 7: Commit-garee isbeddelladaada](#tallaabada-7-commit-garee-isbeddelladaada)
  - [Tallaabada 8: Isbeddelladaada u dir (Push) GitHub](#tallaabada-8-isbeddelladaada-u-dir-push-github)
  - [Tallaabada 9: Gudbi PR (Pull Request)](#tallaabada-9-gudbi-pr-pull-request)
  - [Tallaabada 10: Dabaal-deg](#tallaabada-10-dabaal-deg)
- [Tallaabooyinka Xiga](#tallaabooyinka-xiga)
- [Mahadnaq](#mahadnaq)
- [Shatiga (License)](#shatiga-license)
- [100-ka qof ee ugu horreeya ee ka qayb qaatay](#100-ka-qof-ee-ugu-horreeya-ee-ka-qayb-qaatay)

---

## Hordhac

Kani waa cashar (tutorial) loogu talagalay in lagu caawiyo dadka markii ugu horreysay ka qayb-qaadanaya mashaariicda furan (Open Source) si ay uga qayb galaan mashruuc fudud oo sahlan.

### Ujeedooyinka

- Inaad ka qayb-qaadato mashruuc Open Source ah.
- Inaad si fiican u barato isticmaalka GitHub.

### Yaa loogu talagalay?

- Kani waa mid loogu talagalay kuwa hadda bilaabaya (absolute beginners). Haddii aad taqaanid sida loo qoro ama loo beddelo sumadda (anchor tag) `<a href="" target=""></a>`, markaas waad samayn kartaa.
- Waxa kale oo loogu talagalay dadka khibradda yar leh ee raba inay helaan kalsooni dheeraad ah oo dhanka GitHub ah, ama raba inay sameeyaan ka qayb-qaadashadoodii ugu horreysay ee mashaariicda furan.
...
> [!Note]
> Casharkani wuxuu ku saabsan yahay GitHub Desktop (PC). [Haddii aad aqoon u leedahay Terminal-ka raac casharkan (Halkan Guji)](/terminal_tutorial.md)

Marka hore, aan isku diyaarino qabashada shaqada:

1. Soo gal akoonkaaga GitHub. Haddii aadan wali lahayn akoon [ku biir GitHub](https://github.com/join). Waxaan kugula talinayaa inaad samayso [casharka GitHub Hello World](https://guides.github.com/activities/hello-world/) ka hor intaadan sii socon.
2. Soo dejiso [GitHub Desktop app](https://desktop.github.com/).
   - Haddii kale, haddii aad ku qanacsan tahay isticmaalka Git ee loo maro terminal-ka (command line), waad samayn kartaa [waa kan xiriiriyaha casharka CLI-ga](/terminal_tutorial.md).
   - Haddii aad isticmaasho [VS Code](https://code.visualstudio.com/ 'Visual Studio Code website'), wuxuu la yimaadaa Git ku dhex jira, kaas oo kuu ogolaanaya inaad qabato wax kasta oo aan u baahannahay adigoon ka bixin editor-ka.
   - Si kastaba ha ahaatee, habka ugu fudud uguna sahalan ee loo raaci karo casharkan waa isticmaalka GitHub Desktop.
...
Noqo mid ka qayb qaata mashaariicda furan (open source contributor) adiga oo raacaya 10 tallaabo oo fudud.

_Waqtiga lagu qiyaaso: In ka yar 30 daqiiqo_.
...
- Hadda waxaan u baahannahay inaan furno faylka aan wax ka beddelayno annagoo isticmaalayna editor-ka aad jeceshahay.
- Ka raadi galka mashruuca (project folder) kombuyuutarkaaga. Haddii aad u daaysay meeshii hore, waxay noqon doontaa wax u dhow `your-computer > Documents > GitHub > Contribute-To-This-Project`.
...
#### Tallaabada 6: Codso isbeddelladaada
...
- **Name:** Qor magaca waxa aad soo xiganayso (resource name) qaybta qoraalka `>halkan</a>`.
- Hubi inaad **kaydisay dhammaan isbeddelladaada (Save)**.
...
- Isbeddelladaada waxaa si toos ah loogu dari doonaa qaybta "staging area".
...
#### Tallaabada 9: Gudbi PR (Pull Request)

- Tani waa daqiiqaddii aad sugaysay; gudbinta _Pull Request_ (PR).
- Ilaa hadda shaqada aad qabatay waxay ku dhex jirtay "fork"-ga mashruuca, kaas oo aad xasuusato inuu ku dhex yaallo akoonkaaga GitHub.
- Hadda waa waqtigii aad isbeddelladaada u diri lahayd mashruuca rasmiga ah si loogu daro (merged).
- Tan waxaa loo yaqaannaa [_Pull Request_](https://help.github.com/articles/about-pull-requests/ 'About Pull Requests - GitHub Help') sababtoo ah waxaad ka codsanaysaa maamulaha mashruuca asalka ah inuu "soo jiido" (pull) isbeddelladaada kuna daro mashruucooda.
...
#### Tallaabada 10: Dabaaldeg

Waa intaas. Waad ku guulaysatay! Hadda waxaad gacan ka gaysatay mashruuc furan (open source) oo ku dhex jira GitHub.

Waxaad kood ku dartay mareeg nool: [https://syknapse.github.io/Contribute-To-This-Project](https://syknapse.github.io/Contribute-To-This-Project)

Isbeddelladaada **isla markiiba ma muuqan doonaan**; marka hore waa in la eego, la aqbalo, ka dibna lagu daro (merged) maamulaha mashruuca. Marka lagu daro ka dib, kaadhkaaga wuxuu noqon doonaa mid muuqda oo toos uga jira bogga.

Waa wax iska caadi ah in qofka dib-u-eegista samaynaya uu ku weydiiyo isbeddelo dheeraad ah oo ku saabsan PR-kaaga. U firi inay tahay tababar wanaagsan haddii ay kugu dhacdo. Isha ku hay faallooyinka iyo isbeddellada lagu weydiiyo. Markaad samayso isbeddellada lagu weydiiyo (dib ugu noqo branch-kaaga), waxa kaliya ee aad u baahan tahay inaad samayso waa inaad mar kale "commit" iyo "push" samayso. PR-ka si toos ah ayuu u cusboonaysiin doonaa isbeddellada cusub.
...
- Kani waa mashruuc furan, markaa ka sokow inaad ku darsato kaadhkaaga, waxaa lagugu soo dhoweynayaa inaad ka caawiso hagaajinta khaladaadka (bugs), horumarinta, ama sifooyinka cusub. Fur [issue](https://help.github.com/articles/creating-an-issue/ 'Mastering Issues | GitHub Guides') ama soo dir [pull request](https://help.github.com/articles/creating-a-pull-request-from-a-fork/ 'Creating a pull request from a fork | GitHub Help') cusub.
- Si aad u caawiso horumarinta bulshadayada, fiiri qaybta GitHub [Discussions](https://github.com/Syknapse/Contribute-To-This-Project/discussions) oo ku dhex taal agagaarka Pull Requests. Meeshani waa meel aad isku barayso, aad kaga doodayso Open Source, aadna kula xiriirayso Maamulayaasha Mashruuca. Ma naga caawin doontaa dhisidda sifadan iyo horumarinta bulshadayada?
...
Mashruucan waxaa lagu bixiyay shatiga [MIT License](./LICENSE).

### 100-ka qof ee ugu horreeya ee gacan ka gaystay
