...
| <ul><li>Ссылка: вставьте ссылку `href="сюда"` заменяя `#`</li><li>Заголовок: Напишите краткое описание `title="здесь"`</li><li>Имя: Напишите имя ресурса в текстовом поле `>здесь</a>`</li></ul>                                                                                                                                                          |
