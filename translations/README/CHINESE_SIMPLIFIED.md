> **注意：** 贡献教程已更新。请按照[主 README](https://github.com/Syknapse/Contribute-To-This-Project#readme) 中的当前说明操作 — 无论语言如何，它都是权威指南。
...
> ## **公告：**
>
> 你愿意成为这个项目的维护者并帮助它继续运行吗？如果你有兴趣，请阅读[维护者指南](/maintainer_guide.md)，加入我们的 [Discord 服务器](https://discord.gg/tWkvS4ueVF)，并向项目维护者申请加入团队。
...
- [设置！ :)](#设置-)
- [贡献](#贡献)
  - [第一步：Fork 这个仓库](#第一步fork-这个仓库)
  - [第二步：克隆仓库](#第二步克隆仓库)
  - [第三步：创建新分支](#第三步创建新分支)
  - [第四步：复制模板文件](#第四步复制模板文件)
  - [第五步：填写你的卡片](#第五步填写你的卡片)
  - [第六步：检查你的工作](#第六步检查你的工作)
  - [第七步：提交你的更改](#第七步提交你的更改)
  - [第八步：推送你的更改到 GitHub](#第八步推送你的更改到-github)
  - [第九步：提交 PR（Pull Request）](#第九步提交-prpull-request)
  - [第十步：庆祝](#第十步庆祝)
- [下一步](#下一步)
- [致谢](#致谢)
- [许可证](#许可证)
- [前 100 名贡献者](#前-100-名贡献者)
...
如果你是一名新开发者，正在考虑是否需要学习 Git 和 GitHub，这里有答案：[你昨天就应该学会 Git](https://codeburst.io/number-one-piece-of-advice-for-new-developers-ddd08abc8bfa '新开发者？你昨天就应该学会 Git。作者：Brandon Morelli，CodeBurst.io 创始人')。

### 我要贡献什么？

![Contributor Card](/readme-only/card.PNG 'Contributor Card')

你将向这个[项目的网页](https://syknapse.github.io/Contribute-To-This-Project/ 'https://syknapse.github.io/Contribute-To-This-Project')贡献一张像这样的卡片。它将包含你的名字、联系方式、简短描述，以及你推荐的 3 个对网页开发者有用的链接。
...
> [!注意]
> 本教程基于 GitHub Desktop。[如果你熟悉终端，请转到此教程（点击这里）](/terminal_tutorial.md)

首先让我们设置好工作环境。

1. 登录你的 GitHub 账户。如果你还没有账户，请[加入 GitHub](https://github.com/join)。我建议你在继续之前先完成 [GitHub Hello World 教程](https://guides.github.com/activities/hello-world/)。
2. 下载 [GitHub Desktop 应用](https://desktop.github.com/)。
   - 或者，如果你习惯在命令行使用 Git，也可以这样做。[这里是 CLI 教程的链接](/terminal_tutorial.md)。
   - 如果你使用 [VS Code](https://code.visualstudio.com/ 'Visual Studio Code 网站')，它自带集成 Git，允许你直接从编辑器完成我们需要做的事情。
...
- 确保你在本仓库的[主页面](https://github.com/Syknapse/Contribute-To-This-Project 'https://github.com/Syknapse/Contribute-To-This-Project')。
...
| ![Clone project](/readme-only/clone-project.PNG '点击 =your-github-username=/Contribute-To-This-Project') |
| :-------------------------------------------------------------------------------------------------------: |
...
- 对于接下来的步骤，确保你在这个分支中工作。你会在 GitHub Desktop 应用顶部中央看到你所在分支的名称，那里显示着 _Current branch_。
...
- 在 `cards/` 文件夹中，你会找到一个名为 `template.html` 的文件。那是你的起点。
...
- 将 `Your name` 替换为你的名字。**不要更改 `class="name"`**。
- 将 GitHub 链接和 handle 替换为你自己的。如果你愿意，可以添加更多联系链接 — 前往 [Font Awesome Icons](https://fontawesome.com/icons) 搜索正确的图标（例如 `fab fa-linkedin`、`fab fa-x-twitter`）。同样的模式，只需替换 class。
- 将 `Write a sentence or two about yourself` 替换为简短描述。把它想成更像是一条推文而不是博客文章。
...
- 这是你一直在等待的时刻；提交 _Pull Request_（PR）。
- 到目前为止，你所做的所有工作都在项目的 fork 上，如你所记，它位于你自己的 GitHub 账户中。
- 现在是时候将你的更改发送到主项目以与其合并了。
- 这叫做 [_Pull Request_](https://help.github.com/articles/about-pull-requests/ '关于 Pull Requests - GitHub Help')，因为你正在请求原始项目维护者将你的更改"拉"到他们的项目中。
...
- 现在 _Pull Request_ 将被发送到项目。一个机器人会自动检查你的卡片，如果一切看起来都好，会为你合并它。完成时你会收到 GitHub 通知。
...
你已经向一个实时网页添加了代码：[https://syknapse.github.io/Contribute-To-This-Project](https://syknapse.github.io/Contribute-To-This-Project)

你的卡片将被自动审核，如果一切正确就会被合并。如果机器人发现问题，它会在你的 PR 上留言，准确解释需要修复什么 — 将修复推送到同一分支，它会自动重新检查。

**我的 HTML 文件去哪了？** 一段时间后，提交的卡片会被自动归档以保持仓库轻量。你的 html 文件会自动从 `cards/` 目录中删除，但其数据会保留在归档中。你的卡片仍然会显示在网站上。[了解更多](archive/README.md)。
...
- 为了帮助改善我们的社区，请查看 GitHub [Discussions](https://github.com/Syknapse/Contribute-To-This-Project/discussions) 标签页，位于 Pull Requests 旁边。这个区域是介绍你自己、深入讨论开源、与项目维护者交流的地方。你愿意帮助我们构建这个功能并增强我们的社区吗？
- **感谢你为这个项目做贡献**。现在你可以继续尝试为其他项目做贡献；寻找 ![Good First Issue](https://user-images.githubusercontent.com/29199184/33852733-e23b7070-debb-11e7-907b-4e7a03aad436.png) 标签，找到适合初学者的贡献选项。
- 我也在寻找合作者帮助我审核和合并 PR。如果你想获得更多高级 Git 练习，请阅读[维护者指南](/maintainer_guide.md)，加入我们的 [Discord 服务器](https://discord.gg/tWkvS4ueVF)，并向项目维护者申请加入团队。
...
这个项目深受 [Roshan Jossey's](https://github.com/Roshanjossey) 出色的 [first-contributions](https://github.com/Roshanjossey/first-contributions) 项目及其优秀教程的影响。

它也特别受到 [#GoogleUdacityScholars](https://twitter.com/hashtag/GoogleUdacityScholars?src=hash) 周围伟大社区的启发，The Google Challenge Scholarship: Front-End Web Dev，2017 年欧洲班。
