...
| <ul><li>`Your Name` এর স্থলে আপনার নামটি বসান।</li><li>দ্রষ্টব্যঃ `class="name"` পরিবর্তন করবেন না।</li></ul> | ![Change name](../../readme-only/change-name.PNG 'আপনার নাম লিখুন') |
| :------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------: |
...
| <ul><li>`about you` এর স্থলে আপনার সম্পর্কে আমাদের কিছু বলুন।</li><li>এটিকে ছোট এবং সহজ রাখুন। একটি ব্লগ পোস্টের চেয়ে একটি টুইটের মত কড়ে এটিকে সাজান।</li></ul> | ![Change about](../../readme-only/change-about.PNG 'আপনার সম্পর্কে একটি বাক্য লিখুন') |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------: |
