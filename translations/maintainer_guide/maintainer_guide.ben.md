...
| ০   | ১                                   | ২                                | ৩                                  | ৪                                   | ৫                                  |
| --- | ----------------------------------- | -------------------------------- | ---------------------------------- | ----------------------------------- | ---------------------------------- |
| ১   | [ইংরেজি](../../maintainer_guide.md) | [বাংলা](maintainer_guide.ben.md) | [জার্মান](maintainer_guide.ger.md) | [ইটালিয়ান](maintainer_guide.ita.md) | [জাপানিজ](maintainer_guide.jpn.md) |
