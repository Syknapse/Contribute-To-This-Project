!(function(t, e) {
    ...
    function w(t, e) {
        ...
        if ('/' === t.charAt(e) && '*' === t.charAt(e + 1))
            for (var s = e + 2; s < t.length; ++s) if ('*' === t.charAt(s) && '/' === t.charAt(s + 1)) return s + 2
        return e
    }
    function E(t, e) {
    ...
    function N(t, e) {
        for (var s = null, i = e; i !== s; ) (s = i), (i = w(t, (i = b(t, i)))), (i = g(t, i))
        return T(t, (i = A(t, (i = E(t, i)))))
    }
    function k(t, e) {
        for (var s = null; e !== s; ) (s = e), (e = A(t, (e = E(t, (e = w(t, (e = g(t, e))))))))
        return e
    }
    function F(t, e, s) {
        return k(t, s(e))
    ...
    var L = { '==': !0, '!=': !0, '===': !0, '!==': !0 },
        ...
        M = { '>>': !0, '>>>': !0, '<<': !0 }
    function R(t, e, s) {
        for (var i = 0, r = (s = s || 0); r < t.length; ++r) '\t' === t[r] ? (i = i + e - (i % e)) : i++
        return i
    }
    function B(t, e) {
        var s = t.slice(1, -1),
        ...
        printString: function(t, e, s) {
            ...
            return s
                ? r
                    ? a + i + a
                    : t
                : _(i, a, !('css' === e.parser || 'less' === e.parser || 'scss' === e.parser || e.embeddedInHtml))
        },
    ...
    var V = function(t, e) {
                    ...
                    switch (t.type) {
                        case 'VariableDeclaration':
                            ...
                            s &&
                                ...
                                (function(t, s) {
                                    var i
                                    ';' !== e.originalText[((i = s), 'flow' === e.parser ? i.range[1] : i.end)] &&
        ...
        W = s(function(t, e) {
            ...
            function n(t, e) {
                return void 0 === e && (e = {}), new a(t, Object.assign({}, e, { keyword: t }))
            }
            function o(t, e) {
            ...
            ;(h.parenR.updateContext = h.braceR.updateContext = function() {
                if (1 !== this.state.context.length) {
                    ...
                    t === D.braceStatement && 'function' === this.curContext().token && (t = this.state.context.pop()),
                ...
                (h._function.updateContext = h._class.updateContext = function(t) {
                    ...
                    t === h.semi ||
                    t === h._else ||
                    (t === h._return && c.test(this.input.slice(this.state.lastTokEnd, this.state.start))) ||
                ...
                (h.backQuote.updateContext = function() {
                    this.curContext() === D.template ? this.state.context.pop() : this.state.context.push(D.template),
                        (this.state.exprAllowed = !1)
                })
            var v = {
                    6: x('enum await'),
            ...
            function N(t) {
                return t < 65
                    ...
                    : t <= 90 ||
                          (t < 97
                              ? 95 === t
                              : t <= 122 || (t <= 65535 ? t >= 170 && C.test(String.fromCharCode(t)) : T(t, E)))
            }
            function k(t) {
                return t < 48
                    ? 36 === t
                            ...
                            var i = void 0 === s ? {} : s,
                                ...
                                n = (function(t, e) {
                                    var s,
                                        i = 1,
                                        r = 0
                                    for (l.lastIndex = 0; (s = l.exec(t)) && s.index < e; ) i++, (r = l.lastIndex)
                                    return new U(i, e - r)
                                })(this.input, t)
                            e += ' (' + n.line + ':' + n.column + ')'
            ...
            ;(H.oct = H.bin.concat([50, 51, 52, 53, 54, 55])),
                ...
                (H.hex = H.dec.concat([65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102]))
            var z = (function(t) {
                    function e() {
                        return t.apply(this, arguments) || this
                    }
                        ...
                        return (
                            ...
                            (s.readRegexp = function() {
                                for (var t, e, s = this.state.pos; ; ) {
                                    ...
                                    if ((c.test(i) && this.raise(s, 'Unterminated regular expression'), t)) t = !1
                                    else {
                                        if ('[' === i) e = !0
                                        else if (']' === i && e) e = !1
                                        else if ('/' === i && !e) break
                            ...
                            (s.readInt = function(t, e) {
                                for (
                                    var s = this.state.pos,
                                        ...
                                        r = 16 === t ? H.hex : 10 === t ? H.dec : 8 === t ? H.oct : H.bin,
                                        a = 0,
                                        n = 0,
                                        o = null == e ? 1 / 0 : e;
                                    n < o;
                                    ...
                                    if (this.hasPlugin('numericSeparator')) {
                                        ...
                                        if (95 === h) {
                                            ;-1 === r.indexOf(c) &&
                                                ...
                                                (i.indexOf(p) > -1 || i.indexOf(c) > -1 || Number.isNaN(c)) &&
                                                    this.raise(this.state.pos, 'Invalid or unexpected token'),
                                                ++this.state.pos
                                            continue
                                        }
                                    ...
                                    if (
                                        (u = h >= 97 ? h - 97 + 10 : h >= 65 ? h - 65 + 10 : X(h) ? h - 48 : 1 / 0) >= t
                                    )
                                        break
                            ...
                            (s.readNumber = function(t) {
                                ...
                                r &&
                                    (this.state.strict &&
                                        this.raise(e, 'Legacy octal literals are not allowed in strict mode'),
                            ...
                            (s.readWord1 = function() {
                                ...
                                for (var t = '', e = !0, s = this.state.pos; this.state.pos < this.input.length; ) {
                                    ...
                                    if (k(i)) this.state.pos += i <= 65535 ? 1 : 2
                                        ...
                                        ;(e ? N : k)(a, !0) || this.raise(r, 'Invalid Unicode escape'),
                            ...
                            (s.braceIsBlock = function(t) {
                                ...
                                return (
                                    ...
                                    (t !== h.colon || (e !== D.braceStatement && e !== D.braceExpression)
                                        ? t === h._return || t === h._yield || (t === h.name && this.state.exprAllowed)
                    ...
                    (function(t) {
                        ...
                        return (
                            ...
                            (s.parseStatementContent = function(t, e) {
                                ...
                                return s === h.name && 'Identifier' === u.type && this.eat(h.colon)
                            ...
                            (s.parseMaybeDecoratorArguments = function(t) {
                                if (this.eat(h.parenL)) {
                                    ...
                                    return (
                                        (e.callee = t),
                                        (e.arguments = this.parseCallExpressionArguments(h.parenR, !1)),
                            ...
                            (s.parseForStatement = function(t) {
                                ...
                                var e = !1
                                if (
                                    (this.state.inAsync && this.isContextual('await') && ((e = !0), this.next()),
                            ...
                            (s.parseFunction = function(t, e, s, i, r) {
                                ...
                                return (
                                    ...
                                    e || ((this.state.inAsync = i), (this.state.inGenerator = t.generator)),
                                ...
                                if ((this.parsePostMemberNameModifiers(p), this.isClassMethod())) {
                                    ...
                                    f &&
                                        ...
                                        s.hadConstructor &&
                                            ...
                                            this.raise(c.start, 'Duplicate constructor in the same class'),
                                        (s.hadConstructor = !0)),
                                        this.pushClassMethod(t, r, !1, !1, f)
                                } else if (this.isClassProperty())
                                    l ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n)
                            ...
                            (s.parseExportDefaultExpression = function() {
                                ...
                                if (this.eat(h._function) || e)
                                    return (
                                        e && (this.eatContextual('async'), this.expect(h._function)),
                            ...
                            return (
                                ...
                                (s.parseMaybeAssign = function(t, e, s, i) {
                                    ...
                                    if ((s && (u = s.call(this, u, a, n)), this.state.type.isAssign)) {
                                        ...
                                        if (
                                            ...
                                            ('||=' !== l && '&&=' !== l) || this.expectPlugin('logicalAssignment'),
                                            ...
                                            'ObjectPattern' === u.type
                                                ? (p = '`({a}) = 0` use `({a} = 0)`')
                                                : 'ArrayPattern' === u.type && (p = '`([a]) = 0` use `([a] = 0)`'),
                                                p &&
                                                    this.raise(
                                                        u.start,
                                ...
                                (s.parseExprOp = function(t, e, s, i, r) {
                                    ...
                                    if (!(null == a || (r && this.match(h._in))) && a > i) {
                                        ...
                                        return (
                                            ...
                                            this.finishNode(
                                                n,
                                                u === h.logicalOR || u === h.logicalAND || u === h.nullishCoalescing
                                                    ? 'LogicalExpression'
                                                    : 'BinaryExpression'
                                            ),
                                ...
                                (s.parseSubscript = function(t, e, s, i, r) {
                                    ...
                                    if (!i && this.match(h.parenL)) {
                                        ...
                                        var m = { start: -1 }
                                        return (
                                            (f.arguments = this.parseCallExpressionArguments(h.parenR, d, m)),
                                            r.optionalChainMember
                                ...
                                (s.parseExprAtom = function(t) {
                                    ...
                                    switch (this.state.type) {
                                        ...
                                        case h.regexp:
                                            ...
                                            return (
                                                ((e = this.parseLiteral(m.value, 'RegExpLiteral')).pattern = m.pattern),
                                                (e.flags = m.flags),
                                                e
                                            )
                                        case h.num:
                                        ...
                                        case h._null:
                                            return (
                                                (e = this.startNode()), this.next(), this.finishNode(e, 'NullLiteral')
                                            )
                                        case h._true:
                                        case h._false:
                                        ...
                                        case h.bracketL:
                                            return (
                                                ...
                                                this.state.maybeInArrowParameters || this.toReferencedList(e.elements),
                                        ...
                                        case h._class:
                                            return (
                                                (e = this.startNode()), this.takeDecorators(e), this.parseClass(e, !1)
                                            )
                                        case h._new:
                                ...
                                (s.parseMaybePrivateName = function() {
                                    if (this.match(h.hash)) {
                                        ...
                                        var s = this.state.start
                                        return (
                                            0 != s - e && this.raise(s, 'Unexpected space between # and identifier'),
                                ...
                                (s.parseObj = function(t, e) {
                                    ...
                                    for (var n = null; !this.eat(h.braceR); ) {
                                        ...
                                        ;(o.method = !1),
                                            (t || e) && ((c = this.state.start), (l = this.state.startLoc)),
                                            t || (u = this.eat(h.star))
                                        ...
                                        if (!t && this.isContextual('async')) {
                                            ...
                                            this.match(h.comma)
                                                ...
                                                : ((p = !0), (u = this.eat(h.star)), this.parsePropertyName(o))
                                ...
                                (s.parseFunctionBody = function(t, e) {
                                    ...
                                    if (((this.state.inParameters = !1), s)) t.body = this.parseMaybeAssign()
                                    else {
                                ...
                                (s.parseIdentifierName = function(t, e) {
                                    ...
                                    if (
                                        ...
                                        ;('class' !== (s = this.state.type.keyword) && 'function' !== s) ||
                                ...
                                (s.checkSmartPipelineBodyEarlyErrors = function(t, e, s) {
                                    ...
                                    if ('PipelineTopicExpression' === e && 'SequenceExpression' === t.type)
                                        throw this.raise(
                                            s,
                                ...
                                (s.isStrictBody = function(t) {
                                    if ('BlockStatement' === t.body.type && t.body.body.length > 0)
                                        for (var e = 0, s = t.body.body; e < s.length; e++) {
                                            var i = s[e]
                                            if ('ExpressionStatement' !== i.type || 'Literal' !== i.expression.type)
                                                break
                            ...
                            return (
                                    ...
                                    for (
                                        ...
                                        if (';' === (i = this.input[this.state.pos++])) {
                                            '#' === e[0]
                                                ? 'x' === e[1]
                                                    ? ((e = e.substr(2)),
                                                      R.test(e) && (t = String.fromCodePoint(parseInt(e, 16))))
                                                    : ((e = e.substr(1)),
                                                      B.test(e) && (t = String.fromCodePoint(parseInt(e, 10))))
                                                : (t = M[e])
                                            break
                                        }
                                        e += i
                                ...
                                (s.jsxParseElementAt = function(t, e) {
                                    ...
                                    if (!r.selfClosing) {
                                        ...
                                        _(r) && !_(a)
                                            ...
                                            ? this.raise(
                                                  a.start,
                                                  'Expected corresponding JSX closing tag for <' + j(r.name) + '>'
                                              )
                                            : _(r) ||
                                              _(a) ||
                                              (j(a.name) !== j(r.name) &&
                                    ...
                                    return (
                                        ...
                                        _(r) ? this.finishNode(s, 'JSXFragment') : this.finishNode(s, 'JSXElement')
                                    )
                                }),
                                ...
                                (s.parseExprAtom = function(e) {
                                    return this.match(h.jsxText)
                                        ...
                                        : this.isRelational('<') && 33 !== this.state.input.charCodeAt(this.state.pos)
                            ...
                            return (
                                        ...
                                        i.forEach(function(t) {
                                            !(function(t) {
                                                ...
                                                ? 'DeclareModuleExports' === t.type &&
                                                  ...
                                                  (n = 'CommonJS'),
                                                  (o = !0))
                                                : ('CommonJS' === n && e.unexpected(t.start, u), (n = 'ES'))
                                        }),
                                        (t.kind = n || 'CommonJS'),
                                            ...
                                            null != d && this.unexpected(d),
                                                this.eat(h.bracketL)
                                                    ? (D && this.unexpected(D.start),
                                                      p.internalSlots.push(this.flowParseObjectTypeInternalSlot(f, l)))
                                                    : p.indexers.push(this.flowParseObjectTypeIndexer(f, l, D))
                                        else if (this.match(h.parenL) || this.isRelational('<'))
                                            null != d && this.unexpected(d),
                                                D && this.unexpected(D.start),
                                                p.callProperties.push(this.flowParseObjectTypeCallProperty(f, l))
                                        else {
                                            var x = 'init'
                                            if (this.isContextual('get') || this.isContextual('set')) {
                                                var v = this.lookahead()
                                                ;(v.type !== h.name && v.type !== h.string && v.type !== h.num) ||
                                ...
                                (s.parseObjPropValue = function(e, s, i, r, a, n, o, u) {
                                    ...
                                    e.variance && this.unexpected(e.variance.start),
                                        ...
                                        t.prototype.parseObjPropValue.call(this, e, s, i, r, a, n, o, u),
                                ...
                                (s.parseImportSpecifierLocal = function(t, e, s, i) {
                                    ;(e.local = S(t) ? this.flowParseRestrictedIdentifier(!0) : this.parseIdentifier()),
                                        this.checkLVal(e.local, !0, void 0, i),
                                        t.specifiers.push(this.finishNode(e, s))
                                }),
                                ...
                                (s.parseImportSpecifier = function(t) {
                                    ...
                                    o &&
                                        ...
                                        (o || u) && this.checkReservedType(e.local.name, e.local.start),
                                        !a || o || u || this.checkReservedWord(e.local.name, e.start, !0, !0),
                                        this.checkLVal(e.local, !0, void 0, 'import specifier'),
                                        t.specifiers.push(this.finishNode(e, 'ImportSpecifier'))
                                }),
                                ...
                                (s.parseMaybeAssign = function(e, s, i, r) {
                                    ...
                                    if (
                                        ...
                                        try {
                                            ...
                                            this.state.context[u - 1] === D.j_oTag && (this.state.context.length -= 2),
                                                (n = t)
                                        }
                                    }
                        ...
                        return (function(t) {
                            ...
                            return (
                                        ...
                                        e.elementTypes.forEach(function(i, r) {
                                            'TSRestType' === i.type
                                                ? r !== e.elementTypes.length - 1 &&
                                                  t.raise(i.start, 'A rest element must be last in a tuple type.')
                                ...
                                (s.parseClassMemberWithIsStatic = function(e, s, i, r) {
                                    ...
                                    if (
                                        (h && (a.abstract = !0), u && (o.readonly = !0), !h && !r && !a.accessibility)
                                    ) {
                                    ...
                                    try {
                                        ...
                                        ;(r = this.tsParseTypeParameters()),
                                            'ArrowFunctionExpression' !==
                                                (i = (l = t.prototype.parseMaybeAssign).call.apply(l, [this].concat(n)))
                                ...
                                (s.toReferencedList = function(t, e) {
                                    for (var s = 0; s < t.length; s++) {
                                        ...
                                        i &&
                                            ...
                                            this.raise(i.start, 'Did not expect a type annotation here.')
                                    }
                                    return t
                                }),
                                (s.shouldParseArrow = function() {
                ...
                return (
                    t &&
                        ...
                        (!(function(t) {
                            ...
                            if (rt(t, 'pipelineOperator') && -1 === nt.indexOf(at(t, 'pipelineOperator', 'proposal')))
                                throw new Error(
        ...
        return function(i, r, a) {
            var n,
                ...
                h = [
                    ...
                    G({ strictMode: !0 }, [['decorators', { decoratorsBeforeExport: !1 }]].concat(s)),
                    G({ strictMode: !1 }, [['decorators', { decoratorsBeforeExport: !1 }]].concat(s)),
                ]
            try {
                n = (function(t, e) {
                ...
                throw t(e.message.replace(/ \(.*\)/, ''), { start: { line: e.loc.line, column: e.loc.column + 1 } })
            }
