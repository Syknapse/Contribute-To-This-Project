!(function(r, e) {
            ...
            (function(r, e) {
                ...
                try {
                    for (
                        ...
                        !(u = (o = i.next()).done) && (t.push(o.value), !e || t.length !== e);
                        u = !0
                    );
                } catch (r) {
                    ;(n = !0), (a = r)
    ...
    var i = {},
        ...
        p = function(e) {
            ...
            for (u in (f(i, e), f(o, i), (t = i.prototype)))
                (a = t[u]) && 'object' === r(a) && (t[u] = 'concat' in a ? a.concat() : n(a))
            return i
            function o(r) {
            ...
            toPosition: (function(r) {
                return function(e) {
                    var t = -1,
                        u = r.length
                    if (e < 0) return {}
                    for (; ++t < u; ) if (r[t] > e) return { line: t + 1, column: e - (r[t - 1] || 0) + 1, offset: e }
                    return {}
                }
            })(e),
            toOffset: (function(r) {
            ...
            return (function(r, e) {
                ...
                for (; ++fr < sr; )
                    if ((a === I && (Dr = ir[pr] || 1), (a = vr(fr)) !== R))
                        ...
                        ;(u = vr(v) === P) && (v++, d === Y && B.call(F, n) && ((t = n), (f = F[n]))),
                            (b = 1 + v - D),
                            (u || w) &&
                                (n
                                    ? d === Y
                                        ...
                                        : (u || c(X, b),
                                          ...
                                          ((mr = o) >= 55296 && mr <= 57343) || mr > 1114111
                                              ...
                                              : ((s = M),
                                                lr(o) && c(ur, b),
                                                o > 65535 &&
                                                    ((s += S(((o -= 65536) >>> 10) | 55296)), (o = 56320 | (1023 & o))),
                                                (o = s + S(o))))
                                    : d !== Y && c(er, b)),
                            o
                                ? (Er(),
                                  ...
                                  (g = m))
                                : ((n = r.slice(D - 1, v)), (hr += n), (Dr += n.length), (fr = v - 1))
                    }
                var mr
                return gr.join(M)
                function br() {
                ...
                function Er() {
                    hr && (gr.push(hr), y && y.call(L, hr, { start: g, end: br() }), (hr = M))
                }
            })(r, n)
        },
        B = {}.hasOwnProperty,
    ...
    var sr = function(r) {
        ...
        function u(u, n, a) {
            L(u, { position: e(n), warning: t, text: a, reference: a, textContext: r, referenceContext: r })
        }
    }
    var fr = function(r) {
            return function(e, t) {
    ...
    function Dr(r) {
        ...
        return (
            'text' !== r.type ||
            !r.position ||
            ((e = r.position.start), (t = r.position.end), e.line !== t.line || t.column - e.column === r.value.length)
        )
    }
    var dr = br,
        hr = ['\\', '`', '*', '{', '}', '[', ']', '(', ')', '#', '+', '-', '.', '!', '_', '>'],
    ...
    var vr = [
        ...
        wr = { position: !0, gfm: !0, commonmark: !1, footnotes: !1, pedantic: !1, blocks: (Er && vr) || Er },
        yr = function(e) {
            var t,
                u,
                a = this.options
            ...
            for (t in wr) {
                if (
                    (null == (u = e[t]) && (u = a[t]),
                    ('blocks' !== t && 'boolean' != typeof u) || ('blocks' === t && 'object' !== r(u)))
                )
                    throw new Error('Invalid value `' + u + '` for setting `options.' + t + '`')
                e[t] = u
            }
    ...
    var kr = function() {
            ...
            ;(r = { type: 'root', children: this.tokenizeBlock(e, u), position: { start: t, end: this.eof || n(t) } }),
    ...
    var Vr = function(r, e, t) {
            ...
            for (; ++o < i; )
                if (((u = e.charAt(o)), a))
                    if (((a = !1), (c += s), (l += f), (s = ''), (f = ''), u === zr)) (s = u), (f = u)
                    else
                        for (c += u, l += u; ++o < i; ) {
                ...
                else if (u === Gr && e.charAt(o + 1) === u && e.charAt(o + 2) === u && e.charAt(o + 3) === u)
                    (s += Hr), (o += 3), (a = !0)
    ...
    var Mr = function(r, e, t) {
            ...
            ;(i = ''), (s = ''), (f = ''), (c = ''), (l = '')
            for (; g < h; )
                if (((a = e.charAt(g)), (c += s), (l += f), (s = ''), (f = ''), a === $r)) {
                    for (c ? ((s += a), (f += a)) : (m += a), i = '', g++; g < h && (a = e.charAt(g)) === Yr; )
                        (i += a), g++
    ...
    var re = function(r, e, t) {
            ...
            for (; w < m; ) {
                for (
                    ...
                    w++
                if (
                    (e.charAt(w) === ne ? (w++, (s = !0), e.charAt(w) === ue && w++) : (w = l),
                    (i = e.slice(w, o)),
                    !s && !Wr(i))
                ) {
                    w = l
    ...
    var ae = function(r, e, t) {
            ...
            return (
                (l.column += s.length),
                (l.offset += s.length),
                r((s += f + n))({ type: 'heading', depth: a, children: this.tokenizeInline(f, l) })
            )
        },
        oe = '\n',
        ie = '\t',
    ...
    var fe = function(r, e, t) {
            ...
            for (; ++i < c; )
                if ((u = e.charAt(i)) === n) a++, (l += o + n), (o = '')
                    ...
                    if (u !== de)
                        return a >= be && (!u || u === pe) ? ((l += o), !!t || r(l)({ type: 'thematicBreak' })) : void 0
                    o += u
                }
        },
        pe = '\n',
    ...
    var ve = function(r) {
            var e,
                ...
                a = {}
            for (; n in Ee; )
                (e = Ee[n]), (u += e), e > 1 && (u = Math.floor(u / e) * e), (a[u] = t), (n = r.charAt(++t))
    ...
    var qe = function(r, e, t) {
            ...
            if (R >= Oe) return
            if (((o = e.charAt(T)), (u = x ? je : ze), !0 === Ve[o])) (i = o), (a = !1)
            else {
            ...
            for (; T < O; ) {
                ...
                if (f) {
                    ...
                    x || k || e.charAt(l) !== Le ? x && v && (k = R >= v.indent || R > Oe) : (k = !0), (s = !1), (T = l)
                if (
                    ((D = e.slice(l, c)),
                    (p = l === T ? D : e.slice(T, c)),
                    (f === Fe || f === ke || f === xe) && B.thematicBreak.call(this, r, D, !0))
                )
                    break
            ...
            ;(C = r(m.join(Be)).reset({ type: 'list', ordered: a, start: N, loose: null, children: [] })),
                (E = this.enterList()),
                (w = this.enterBlock()),
                (A = !1),
                (T = -1),
    ...
    function Ge(r, e, t) {
        ...
        return (
            ...
            r.options.gfm &&
                (u = e.match(Re)) &&
                ((n = u[0].length), (o = u[1].toLowerCase() === Te), (a[t.line] += n), (e = e.slice(n))),
            {
                type: 'listItem',
    ...
    var $e = function(r, e, t) {
            ...
            if (t) return !0
            return r(f + n)({ type: 'heading', depth: i, children: this.tokenizeInline(u, c) })
        },
        Ze = '\n',
        Ye = '\t',
        _e = ' ',
    ...
    function bt(r, e, t) {
        ...
        if (this.options.footnotes) {
            for (u = 0, n = e.length, a = '', o = r.now(), i = o.line; u < n && ((f = e.charAt(u)), Br(f)); )
                (a += f), u++
            if (e.charAt(u) === Dt && e.charAt(u + 1) === ht) {
                for (u = (a += Dt + ht).length, l = ''; u < n && (f = e.charAt(u)) !== dt; )
                    f === lt && ((l += f), u++, (f = e.charAt(u))), (l += f), u++
                if (l && e.charAt(u) === dt && e.charAt(u + 1) === gt) {
                    if (t) return !0
                    for (p = it(l), u = (a += l + dt + gt).length; u < n && ((f = e.charAt(u)) === ft || f === pt); )
                        (a += f), u++
    ...
    function Ot(r, e, t) {
        for (
            var u, n, a, o, i, c, l, s, f = this.options.commonmark, p = 0, D = e.length, d = '';
        ...
        if ((o = e.charAt(p)) === Ft) {
            ...
            if (a && e.charAt(p) === kt && e.charAt(p + 1) === Bt) {
                ...
                if (a) {
                    ...
                    if (
                        ((i = null),
                        (o = e.charAt(p)) === Et ? (i = Et) : o === wt ? (i = wt) : o === xt && (i = Lt),
                        i)
                    ) {
                        if (!a) return
                    ...
                    return (o = e.charAt(p)) && o !== At
                        ...
                        : !!t ||
                              ((u = r(u).test().end),
                              (l = this.decode.raw(this.unescape(l), u, { nonTerminated: !1 })),
                              s && ((n = r(n).test().end), (s = this.decode.raw(this.unescape(s), n))),
                              r(d)({ type: 'definition', identifier: it(c), title: s || null, url: l }))
                }
            }
        }
    }
    ...
    var Ut = function(r, e, t) {
            ...
            for (; u < c; ) {
                if (
                    ((C = e.indexOf(Ht, u)), (q = e.indexOf(zt, u + 1)), -1 === C && (C = e.length), -1 === q || q > C)
                ) {
                    if (E < Zt) return
                    break
                }
            ...
            if (t) return !0
            ;(v = -1), (y = []), (A = r(o).reset({ type: 'table', align: D, children: y }))
            for (; ++v < E; ) {
                for (
                    w = l[v],
                        ...
                        if ('' === f || f === zt)
                            if (h) r(f)
                                ...
                                ;(!d && !f) ||
                                    ...
                                    s.length > 1 &&
                                        (f
                                            ? ((o += s.slice(0, s.length - 1)), (s = s.charAt(s.length - 1)))
                                            : ((o += s), (s = ''))),
                                    (b = r.now()),
                                    r(o)({ type: 'tableCell', children: this.tokenizeInline(d, b) }, i)),
                                    r(s + f),
                                    (s = ''),
                                    (d = '')
                            }
    ...
    var Kt = function(r, e, t) {
            ...
            if (t) return !0
            return (i = r.now()), (n = Pr(n)), r(n)({ type: 'paragraph', children: this.tokenizeInline(n, i) })
        },
        Wt = '\n',
        Xt = '\t',
        ru = ' ',
    ...
    function nu(r, e, t) {
        var u, n
        if ('\\' === e.charAt(0) && ((u = e.charAt(1)), -1 !== this.escape.indexOf(u)))
            return !!t || ((n = '\n' === u ? { type: 'break' } : { type: 'text', value: u }), r('\\' + u)(n))
    }
    nu.locator = tu
    var au = function(r, e) {
        return r.indexOf('<', e)
    ...
    function Du(r, e, t) {
        ...
        if (e.charAt(0) === iu) {
            for (
                ...
                a < n && ((i = e.charAt(a)), !(Br(i) || i === cu || i === lu || (':' === i && e.charAt(a + 1) === su)));
            ...
            if (o) {
                ...
                if (((i = e.charAt(a)), o && i === cu))
                    return (
                        ...
                        D(),
                        r(u)({ type: 'link', title: null, url: L(l, { nonTerminated: !1 }), children: f }))
                    )
            }
        }
    }
            ...
            if (u) {
                ...
                if (f) {
                    ...
                    return (
                        ...
                        d(),
                        r(u)({ type: 'link', title: null, url: L(u, { nonTerminated: !1 }), children: n }))
                    )
                }
            }
        }
    ...
    function Su(r, e, t) {
        ...
        if (
            !('<' !== e.charAt(0) || a < 3) &&
            ((u = e.charAt(1)), (C(u) || '?' === u || '!' === u || '/' === u) && (n = e.match(ku)))
        )
            return (
                !!t ||
                ((n = n[0]),
                !this.inLink && Lu.test(n) ? (this.inLink = !0) : this.inLink && Bu.test(n) && (this.inLink = !1),
            ...
            if (u) {
                ...
                if (((C = e.charAt(A)), (y += m), m && Nu.call(s, C)))
                    if ((A++, (y += C), (m = ''), (D = s[C]), (i = y), F)) {
                        ...
                        for (c = ''; A < d; ) {
                            if ((C = e.charAt(A)) === D) l && ((m += D + c), (c = '')), (l = !0)
                            else if (l) {
                                if (C === Vu) {
                                    ;(y += m + D + c), (h = m)
                                    break
                ...
                if (e.charAt(A) === Vu)
                    return (
                        !!t ||
                        ((y += Vu),
                        (b = this.decode.raw(this.unescape(b), r(o).test().end, { nonTerminated: !1 })),
                        h && ((i = r(i).test().end), (h = this.decode.raw(this.unescape(h), i))),
        ...
        if (('!' === f && ((g = _u), (h = f), (f = e.charAt(++p))), f === en)) {
            ...
            if (((d = c), (u = c), (f = e.charAt(p)) === tn)) {
                ...
                if (((f = e.charAt(p)), g !== Ju && f === en)) {
                    for (n = '', c += f, p++; p < D && (f = e.charAt(p)) !== en && f !== tn; )
                ...
                if (m === Wu || !l)
                    return (
                        ...
                        g === Yu && this.inLink
                            ...
                            : !!t ||
                              (g === Ju && -1 !== u.indexOf(' ')
                                  ? r(d)({ type: 'footnote', children: this.tokenizeInline(u, r.now()) })
                                  : (((a = r.now()).column += h.length),
                                    (a.offset += h.length),
                                    (o = { type: g + 'Reference', identifier: it((n = m === Wu ? n : u)) }),
                                    (g !== Yu && g !== _u) || (o.referenceType = m),
                                    g === Yu
                                        ? ((i = this.enterLink()), (o.children = this.tokenizeInline(u, a)), i())
                                        : g === _u && (o.alt = this.decode.raw(this.unescape(u), a) || null),
                                    r(d)(o)))
                    )
            }
        }
    ...
    function ln(r, e, t) {
        ...
        if (
            ...
            for (; s < c; ) {
                if (
                    ((l = f),
                    !((f = e.charAt(s)) !== a || e.charAt(s + 1) !== a || (n && Br(l))) && (f = e.charAt(s + 2)) !== a)
                ) {
                    if (!Wr(o)) return
                    return (
                        !!t ||
                        (((u = r.now()).column += 2),
                        (u.offset += 2),
                        r(i + o + i)({ type: 'strong', children: this.tokenizeInline(o, u) }))
                    )
                }
                ...
                if (((l = f), !((f = e.charAt(s)) !== a || (n && Br(l))))) {
                    if ((f = e.charAt(++s)) !== a) {
                        ...
                        return (
                            ...
                            ((u = r.now()).column++,
                            u.offset++,
                            r(i + o + a)({ type: 'emphasis', children: this.tokenizeInline(o, u) }))
                        )
                    }
                    o += a
                }
    ...
    function yn(r, e, t) {
        var u,
            ...
            c = '',
            l = ''
        if (this.options.gfm && e.charAt(0) === En && e.charAt(1) === En && !Br(e.charAt(2)))
            for (u = 1, n = e.length, (a = r.now()).column += 2, a.offset += 2; ++u < n; ) {
                if (!((o = e.charAt(u)) !== En || i !== En || (c && Br(c))))
                    return !!t || r(wn + l + wn)({ type: 'delete', children: this.tokenizeInline(l, a) })
                ;(l += i), (c = i), (i = o)
            }
    }
    var An = function(r, e) {
    ...
    var qn = '`'
    function Fn(r, e, t) {
        for (var u, n, a, o, i, c, l, s, f = e.length, p = 0, D = '', d = ''; p < f && e.charAt(p) === qn; )
            (D += qn), p++
        if (D) {
            ...
            for (u = '', n = '', f = D.length, p = -1; ++p < f; )
                (c = D.charAt(p)), Br(c) ? (n += c) : (n && (u && (u += n), (n = '')), (u += c))
    ...
    function Ba(r) {
        ...
        for (
            this.data = {}, this.messages = [], this.history = [], this.cwd = da.cwd(), t = -1, u = La.length;
            ++t < u;
    ...
    var ja = function(r) {
        ...
        Ma = (function e() {
            ...
            i.data = function(r, e) {
                if (za(r))
                    return 2 === arguments.length ? (Ka('data', a), (n[r] = e), i) : (Za.call(n, r) && n[r]) || null
            ...
            function c() {
                ...
                for (; ++o < t.length; )
                    (r = t[o]),
                        ...
                        (n = r[1]),
                        (c = null),
                        !1 !== n && (!0 === n && (r[1] = void 0), (c = e.apply(i, r.slice(1))), ja(c) && u.use(c))
                return (a = !0), (o = 1 / 0), i
            }
            function l(r, e, t) {
            ...
            splitText: function(r, e) {
                ...
                return (
                    ('preserve' === e.proseWrap
                        ? r
                        : r.replace(new RegExp('('.concat(lo, ')\n(').concat(lo, ')'), 'g'), '$1$2')
                    )
                        .split(/([ \t\n]+)/)
                        .forEach(function(r, e, i) {
                            e % 2 != 1
                                ? ((0 !== e && e !== i.length - 1) || '' !== r) &&
                                  r.split(new RegExp('('.concat(lo, ')'))).forEach(function(r, e, a) {
                                      ;((0 !== e && e !== a.length - 1) || '' !== r) &&
                                          (e % 2 != 0
                                              ? o(
                                                    mo.test(r)
        ...
        vo = o(function(r) {
            var e = /^import/,
                ...
                a = function(r, e) {
                    var t = e.indexOf('\n\n'),
                        a = e.slice(0, t)
                    if (n(a) || u(a)) return r(a)({ type: n(a) ? 'export' : 'import', value: a })
                }
                ...
                ;(t.math = function(r, e, t) {
                    ...
                    if (((f = d), (a = e.charAt(d)) === ko)) {
                        ...
                        if (!(u < xo)) {
                            ...
                            for (
                                (p = r.now()).column += h.length, p.offset += h.length, o = l = s = i = c = '';
                                d < D;

                            )
                                if (((i += l), (c += s), (l = s = ''), (a = e.charAt(d)) === Co)) {
                                    for (
                                        i ? ((l += a), (s += a)) : (h += a), o = '', d++;
                                        d < D && (a = e.charAt(d)) === Fo;
    ...
    function Oo(r) {
        ...
        return function(r) {
            var t = Ma()
                .use(Un, Object.assign({ footnotes: !0, commonmark: !0 }, e && { blocks: [vo.BLOCKS_REGEX] }))
                .use(Uo)
                .use(Bo)
    ...
    function Ro() {
        return function(r) {
            return So(r, function(r, t, u) {
                var n = e(u, 1)[0]
                return 'html' !== r.type || /^<!--[\s\S]*-->$/.test(r.value) || -1 !== To.indexOf(n.type)
                    ? r
    ...
    return { parsers: { remark: Vo, markdown: Vo, mdx: Object.assign({}, Io, { parse: Oo({ isMDX: !0 }) }) } }
})
