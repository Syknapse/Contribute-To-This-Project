!(function(e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(t)
        : ((e.prettierPlugins = e.prettierPlugins || {}), (e.prettierPlugins.angular = t()))
})(this, function() {
    'use strict'
    var e = function(e) {
            ...
            (function(e, t) {
                ...
                try {
                    for (
                        ...
                        !(i = (a = o.next()).done) && (n.push(a.value), !t || n.length !== t);
                        i = !0
                    );
                } catch (e) {
                    ;(r = !0), (s = e)
    ...
    var x = function e(t, n, i, r) {
        ...
        b = (function(e) {
            function t(e, n, i, r) {
                var a
                return (
                    s(this, t), ((a = h(this, l(t).call(this, e))).condition = n), (a.trueExp = i), (a.falseExp = r), a
                )
            }
            return (
                u(t, k),
        ...
        G = (function(e) {
            function t(e, n, i, r) {
                ...
                return (
                    s(this, t),
                    ((a = h(this, l(t).call(this, new g(0, null == n ? 0 : n.length)))).ast = e),
                    (a.source = n),
                    (a.location = i),
                    (a.errors = r),
                    a
                ...
                o(e, [
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return (
                                this.advance(),
                                this.error('Unexpected character ['.concat(String.fromCharCode(n), ']'), 0)
                            )
                        },
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            for (this.advance(); ; ) {
                                if (be(this.peek));
                                    ...
                                    if ((this.advance(), Te(this.peek) && this.advance(), !be(this.peek)))
                            ...
                            for (var n = '', i = this.index, r = this.input; this.peek != t; )
                                if (92 == this.peek) {
                                    ...
                                    if (((this.peek = this.peek), 117 == this.peek)) {
                                        ...
                                        if (!/^[0-9a-f]+$/i.test(a))
                                            return this.error('Invalid unicode escape [\\u'.concat(a, ']'), 0)
                                        s = parseInt(a, 16)
    ...
    var ze = (function() {
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            return (
                                r.length > 0 &&
                                    this._reportError(
                                        'Host binding expression cannot contain '.concat(r.join(' ')),
                                        e,
                                        t
                                    ),
                        ...
                        value: function(e, t) {
                            ...
                            for (var s = [], a = [], o = [], u = 0, l = 0; l < r.length; l++) {
                                ...
                                l % 2 == 0
                                    ? (s.push(c), (u += c.length))
                                    : c.trim().length > 0
                                    ? ((u += n.start.length), a.push(c), o.push(u), (u += c.length + n.end.length))
                                    : (this._reportError(
                                          'Blank expressions are not allowed in interpolated strings',
                                          e,
                                          'at column '.concat(this._findInterpolationErrorColumn(r, l, n), ' in'),
                                          t
                                      ),
                                      a.push('$implict'),
                                      o.push(u))
                        ...
                        value: function(e, t, n) {
                            ...
                            r.length > 1 &&
                                this._reportError(
                                    ...
                                    e,
                                    'at column '.concat(this._findInterpolationErrorColumn(r, 1, n), ' in'),
                                    t
                                )
                        },
                    },
                ...
                o(e, [
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return e.isIdentifier() || e.isKeyword()
                                ...
                                : (this.error('Unexpected token '.concat(e, ', expected identifier or keyword')), '')
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return e.isIdentifier() || e.isKeyword() || e.isString()
                                ? (this.advance(), e.toString())
                                : (this.error(
                                      'Unexpected token '.concat(e, ', expected identifier, keyword, or string')
                                  ),
                                  '')
                        },
                    },
                        ...
                        value: function() {
                            ...
                            if (this.optionalOperator('?')) {
                                ...
                                if (this.optionalCharacter(58)) n = this.parsePipe()
                                    ...
                                    this.error('Conditional expression '.concat(s, ' requires all 3 expressions')),
                                        (n = new w(this.span(e)))
                                }
                    ...
                    },
                    {
                        ...
                        value: function() {
                            for (var e = this.parsePrimary(); ; )
                                if (this.optionalCharacter(46)) e = this.parseAccessMemberOrMethodCall(e, !1)
                                else if (this.optionalOperator('?.')) e = this.parseAccessMemberOrMethodCall(e, !0)
                                else if (this.optionalCharacter(91)) {
                                    this.rbracketsExpected++
                                    var t = this.parsePipe()
                                    if (
                                        (this.rbracketsExpected--, this.expectCharacter(93), this.optionalOperator('='))
                                    ) {
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (this.next.isIdentifier())
                                return this.parseAccessMemberOrMethodCall(new C(this.span(e)), !1)
                            ...
                            return this.index >= this.tokens.length
                                ? (this.error('Unexpected end of expression: '.concat(this.input)), new w(this.span(e)))
                                : (this.error('Unexpected token '.concat(this.next)), new w(this.span(e)))
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if ((this.expectCharacter(123), !this.optionalCharacter(125))) {
                                ...
                                do {
                                    ...
                                    e.push({ key: r, quoted: i }), this.expectCharacter(58), t.push(this.parsePipe())
                                } while (this.optionalCharacter(44))
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            if (this.optionalOperator('=')) {
                                if (!this.parseAction)
                                    return this.error('Bindings cannot contain assignments'), new w(this.span(n))
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            do {
                                ...
                                var o = null,
                                    u = null
                                if (a) o = this.optionalOperator('=') ? this.expectTemplateBindingKey() : '$implicit'
                                else if (this.peekKeywordAs())
                                    this.advance(), (o = r), (s = this.expectTemplateBindingKey()), (a = !0)
                    ...
                    },
                    {
                        ...
                        value: function() {
                            for (
                                ...
                                this.next.isError() &&
                                    this.errors.push(
                                        new x(this.next.toString(), this.input, this.locationText(), this.location)
                                    ),
                                    this.advance(),
                                    (e = this.next)
                        },
        ...
        De = Object.freeze({ SplitInterpolation: We, TemplateBindingParseResult: Ue, Parser: ze, _ParseAST: $e }),
        He = i(function(e, t) {
            Object.defineProperty(t, '__esModule', { value: !0 })
            ...
            function u(e, t) {
                ...
                return null === n
                    ...
                    : {
                          ...
                          comments: [
                              { type: 'Comment', value: e.slice(n + '//'.length), span: { start: n, end: e.length } },
                          ],
                      }
            }
            function l(e, t) {
        ...
        function n(e, t, n, i) {
            if (!n) {
                ...
                return {
                    ...
                    loc: { start: t.locator.locationForIndex(r), end: t.locator.locationForIndex(s) },
                }
            }
            ...
            return Object.assign(
                {
                    ...
                    loc: { start: t.locator.locationForIndex(u.start), end: t.locator.locationForIndex(u.end) },
                },
                l && { extra: { parenthesized: !0, parenStart: o.start, parenEnd: o.end } }
            )
        }
        Object.defineProperty(t, '__esModule', { value: !0 }),
                ...
                switch (a) {
                    case 'Binary':
                        ...
                        var v = le(o),
                            f = le(l)
                        return he(
                            '&&' === u || '||' === u ? 'LogicalExpression' : 'BinaryExpression',
                    ...
                    case 'BindingPipe':
                        var d = e.exp,
                            ...
                            g = le(d),
                            k = fe(/\S/, fe(/\|/, ge(g)) + 1),
                            m = he('Identifier', { name: y }, { start: k, end: k + y.length }),
                            w = x.map(le)
                        return he(
                            'NGPipeExpression',
                    ...
                    case 'Chain':
                        return he('NGChainedExpression', { expressions: e.expressions.map(le) }, e.span, {
                            hasParentParens: s,
                        })
                    case 'Comment':
                        return he('CommentLine', { value: e.value }, e.span, { processSpan: !1 })
                    case 'Conditional':
                        var C = e.condition,
                            P = e.trueExp,
                            b = e.falseExp,
                    ...
                    case 'LiteralArray':
                        return he('ArrayExpression', { elements: e.expressions.map(le) }, e.span, {
                            hasParentParens: s,
                        })
                    case 'LiteralMap':
                        var T = e.keys,
                            ...
                            'ObjectExpression',
                            {
                                properties: T.map(function(t, n) {
                                    var i = t.key,
                                        ...
                                        o = r ? he('StringLiteral', { value: i }, a) : he('Identifier', { name: i }, a)
                                    return he(
                                        'ObjectProperty',
                    ...
                    case 'LiteralPrimitive':
                        ...
                        switch (r(R)) {
                            case 'boolean':
                                return he('BooleanLiteral', { value: R }, e.span, { hasParentParens: s })
                            case 'number':
                                return he('NumericLiteral', { value: R }, e.span, { hasParentParens: s })
                            case 'object':
                                return he('NullLiteral', {}, e.span, { hasParentParens: s })
                            case 'string':
                                return he('StringLiteral', { value: R }, e.span, { hasParentParens: s })
                            case 'undefined':
                                return he('Identifier', { name: 'undefined' }, e.span, { hasParentParens: s })
                            default:
                    ...
                    case 'SafeMethodCall':
                        var j = 'SafeMethodCall' === a,
                            ...
                            Q = pe(F, he('Identifier', { name: V }, { start: U - V.length, end: U }), {
                                computed: !1,
                                optional: j,
                            }),
                            z = de(Q)
                    ...
                    case 'KeyedWrite':
                        var Y = e.obj,
                            ...
                            te = le(Z),
                            ne = le(ee),
                            ie = pe(Y, te, { computed: !0, optional: !1 }, { end: fe(/\]/, ge(te)) + 1 })
                        return he(
                    ...
                    case 'PropertyWrite':
                        var re = e.receiver,
                            ...
                            ue = pe(re, he('Identifier', { name: se }, { start: oe - se.length, end: oe }), {
                                computed: !1,
                                optional: !1,
                            })
                        return he(
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.transformTemplateBindings = function(e, t) {
                for (
                    var n = p(e, 1)[0],
                        i = n.key,
                        r = 0 === t.text.slice(n.span.start, n.span.end).trim().length ? e.slice(1) : e,
                        s = [],
                        a = null,
                        o = 0;
                    o < r.length;
                    ...
                    var u = r[o],
                        ...
                        h = u.name,
                        v = u.span
                    a && a.key === h && c && /^as\s$/.test(t.text.slice(v.start, v.start + 3))
                        ? (function() {
                              var e = x(He.findBackChar(/\S/, v.start + 3, t.text), l),
                                  n = y('NGMicrosyntaxKey', { name: l }, e),
                                  i = function(e, n) {
                                      return Object.assign({}, e, Je.transformSpan({ start: e.start, end: n }, t))
                                  },
                                  r = function(e) {
                ...
                return y(
                    'NGMicrosyntax',
                    { body: s },
                    0 === s.length ? e[0].span : { start: s[0].start, end: s[s.length - 1].end }
                )
                function f(e, n) {
                    var i = e.key,
                        r = e.keyIsVar,
                                    ...
                                    value:
                                        0 === t.text.slice(u.end, o.end).trim().length
                                            ...
                                            : y(
                                                  'NGMicrosyntaxKey',
                                                  { name: s },
                                                  { start: He.findBackChar(/=/, u.end, t.text) + 1, end: o.end }
                                              ),
                                },
                                o
                            )
                        ...
                        return y(
                            'NGMicrosyntaxAs',
                            {
                                ...
                                alias: y(
                                    'NGMicrosyntaxKey',
                                    { name: i },
                                    { start: He.findBackChar(/\S/, l.end, t.text) + 'as'.length, end: o.end }
                                ),
                            },
                            o
                        )
                    ...
                    if (a) {
                        if (0 === n) return y('NGMicrosyntaxExpression', { expression: d(a.ast), alias: null }, o)
                        var c = d(a.ast),
                            h = c.start,
                            p = c.end,
                            v = g(i)
                ...
                function x(e, n) {
                    if ("'" !== t.text[e] && '"' !== t.text[e]) return { start: e, end: e + n.length }
                    ...
                    return {
                        ...
                        node:
                            '__ng_action' === i.parser && 'NGChainedExpression' !== r.type
                                ? Object.assign({}, r, { type: 'NGChainedExpression', expressions: [r] })
                                : r,
                    }
                },
            },
