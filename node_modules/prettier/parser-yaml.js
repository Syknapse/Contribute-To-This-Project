!(function(e, t) {
    ...
    var w = Object.freeze({
            ...
            __asyncDelegator: function(e) {
                ...
                function r(r, a) {
                    t[r] = e[r]
                        ? function(t) {
                              return (n = !n) ? { value: b(e[r](t)), done: 'return' === r } : a ? a(t) : t
                          }
                        : a
                }
            },
                ...
                u(e, null, [
                    ...
                    },
                    {
                        ...
                        value: function(t, n, r) {
                            ...
                            return i || (i = ' '), u && a <= r && (o = !0), { fold: i, offset: n, error: o }
                        },
                    },
                ]),
                u(e, [
                    ...
                    },
                    {
                        ...
                        get: function() {
                            ...
                            for (
                                var e = this.valueRange, t = e.start, n = e.end, r = this.context.src, a = t;
                                a < n;
                                ++a
                            )
                                if ('\n' === r[a]) return !0
                ...
                u(t, [
                    {
                        ...
                        value: function(e) {
                            ...
                            this.directives = []
                            for (var i = !1, u = e; !a.default.atDocumentBoundary(o, u, a.Char.DIRECTIVES_END); )
                                switch (o[(u = t.startCommentOrEndBlankLine(o, u))]) {
                                    ...
                                    case '%':
                                        var f = new r.default()
                                        ;(u = f.parse({ parent: this, src: o }, u)), this.directives.push(f), (i = !0)
                                        break
                                    default:
                                        return (
                                            i
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return (
                                e.length > 0 &&
                                    ((t.length > 0 || e[0].type === a.Type.COMMENT) && (r += '---\n'),
                                    (r += e.join(''))),
                                '\n' !== r[r.length - 1] && (r += '\n'),
                                r
                            )
                ...
                u(t, [
                    {
                        ...
                        value: function(e, t) {
                            ...
                            for (
                                var s = i ? t - u : e.indent, f = r.default.endOfWhiteSpace(o, t + 1), c = o[f];
                                '\n' === c || '#' === c;
                            ...
                            r.default.nextNodeIsIndented(c, f - (u + s), this.type !== r.Type.SEQ_ITEM)
                                ? ((this.node = n(
    ...
    var C = r(function(e, t) {
        ...
        var c = (function(e) {
            function t(e) {
                var n
                o(this, t),
                    ((n = p(this, f(t).call(this, e.type === r.Type.SEQ_ITEM ? r.Type.SEQ : r.Type.MAP))).items = [e])
                ...
                u(t, [
                    {
                        ...
                        value: function(e, t) {
                            ...
                            for (
                                ...
                                var y = o(
                                    { atLineStart: d, inCollection: !0, indent: f, lineStart: u, parent: this },
                                    c
                                )
                                if (!y) return c
                                if (
                    ...
                    [
                        {
                            ...
                            value: function(e) {
                                for (
                                    var r = this.context, a = r.indent, o = r.inFlow, i = r.src, u = e, s = i[u];
                        ...
                        },
                        {
                            ...
                            get: function() {
                                if (!this.valueRange || !this.context) return null
                                for (
                                    var e = this.valueRange, t = e.start, r = e.end, a = this.context.src, o = a[r - 1];
                                    t < r && ('\n' === o || '\t' === o || ' ' === o);
                                        ...
                                        switch (u[(f += 1)]) {
                                            ...
                                            default:
                                                e.push(
                                                    new S.YAMLSyntaxError(
                                                        this,
                                                        'Invalid escape sequence '.concat(u.substr(f - 1, 2))
                                                    )
                                                ),
                                                    (s += '\\' + u[f])
                                        }
            ...
            function e() {
                ...
                o(this, e),
                    ...
                    (u = 'parseNode') in (t = this)
                        ? Object.defineProperty(t, u, { value: p, enumerable: !0, configurable: !0, writable: !0 })
                        : (t[u] = p),
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            for (
                                ...
                                u === f.Char.ANCHOR || u === f.Char.COMMENT || u === f.Char.TAG || '\n' === u;
                ...
                u(t, [
                    ...
                    },
                    {
                        ...
                        value: function(e, r, a) {
                            ...
                            d && (s += '  '), (e = Object.assign({}, e, { indent: s, inFlow: d, type: null }))
                            var h,
                                p = !1,
                                v = !1,
                            ...
                            return (
                                this.comment &&
                                    ((h += '\n' + this.comment.replace(/^/gm, ''.concat(l, '#'))), a && a()),
                                h
                            )
                        },
                    },
        ...
        var l = (function(e) {
            function t(e) {
                ...
                if ((o(this, t), e instanceof n.default)) {
                    var u = e.value
                    u instanceof a.default || ((u = new a.default()).items.push(e.value), (u.range = e.value.range)),
    ...
    var G = r(function(e, t) {
        ...
        ;(t.default = d),
            (l = !0),
            (c = 'default') in (i = d)
                ? Object.defineProperty(i, c, { value: l, enumerable: !0, configurable: !0, writable: !0 })
                : (i[c] = l),
            (e.exports = t.default),
            (e.exports.default = t.default)
    })
                ...
                u(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                for (
                                    var e = this, t = new a.default(), o = arguments.length, i = new Array(o), u = 0;
                                    u < o;
                                    u++
                                )
                                    i[u] = arguments[u]
    ...
    var X = r(function(e, t) {
        ...
        function f(e, t, a) {
            ...
            d !== M.Type.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(h)
                ...
                : (!f && !c) || (d !== M.Type.BLOCK_FOLDED && d !== M.Type.BLOCK_LITERAL) || (d = M.Type.QUOTE_DOUBLE)
            var v = p(d)
            if (null === v && null === (v = p(o))) throw new Error('Unsupported default string type '.concat(o))
            return v
        }
        t.resolve = o
        var c = { class: String, default: !0, tag: 'tag:yaml.org,2002:str', resolve: o, stringify: f, options: r }
        t.str = c
    })
    n(X)
            ...
            (t.default = function(e, t) {
                ...
                var s =
                        t.type === M.Type.FLOW_MAP
                            ? (function(e, t) {
                                  for (
                                      var n = [], r = [], a = void 0, i = null, u = !1, s = '{', f = 0;
                                      f < t.items.length;
                                      ++f
                                  ) {
                                      ...
                                      if ('string' == typeof c.char) {
                                          ...
                                          if (':' === l) {
                                              ...
                                              (u && (void 0 === a && ',' !== l && (a = null), (u = !1)),
                                              void 0 !== a &&
                                                  (r.push(new o.default(a)), (a = void 0), (i = null), ',' === l))
                                          ) {
                                              s = ':'
                                              continue
                                          }
                                          ...
                                          e.errors.push(
                                              new S.YAMLSyntaxError(t, 'Flow map contains an unexpected '.concat(l))
                                          )
                                      } else
                                          c.type === M.Type.COMMENT
                                              ...
                                              ? (',' === s &&
                                                    e.errors.push(
                                                        new S.YAMLSemanticError(c, 'Separator , missing in flow map')
                                                    ),
                                                (a = e.resolveNode(c)),
                                  ...
                                  '}' !== t.items[t.items.length - 1].char &&
                                      e.errors.push(new S.YAMLSemanticError(t, 'Expected flow map to end with }'))
            ...
            (t.default = function(e, t) {
                ...
                var o =
                        t.type === M.Type.FLOW_SEQ
                            ? (function(e, t) {
                                  for (
                                      var r = [], a = [], o = !1, i = void 0, u = null, s = '[', f = 0;
                                      f < t.items.length;
                                      ++f
                                  ) {
                                      var c = t.items[f]
                                      if ('string' == typeof c.char) {
                                          ...
                                          void 0 === i ? a.push(p) : (a.push(new n.default(i, p)), (i = void 0)),
                                              (u = c.range.start),
                                              (s = ',')
                                      }
                                  }
                                  ']' !== t.items[t.items.length - 1].char &&
                                      e.errors.push(new S.YAMLSemanticError(t, 'Expected flow sequence to end with ]'))
    ...
    var ae = r(function(e, t) {
        Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = t.nullOptions = t.stringifyNumber = void 0)
        var n,
    ...
    var oe = r(function(e, t) {
        ...
        var n = [
            re.map,
            re.seq,
            { class: String, default: !0, tag: 'tag:yaml.org,2002:str', resolve: X.resolve },
            {
                class: null,
                default: !0,
                tag: 'tag:yaml.org,2002:null',
    ...
    function de(e, t, n) {
        for (var r, a, o = [], i = t; i < n; i += 3)
            (r = (e[i] << 16) + (e[i + 1] << 8) + e[i + 2]),
                o.push(ue[((a = r) >> 18) & 63] + ue[(a >> 12) & 63] + ue[(a >> 6) & 63] + ue[63 & a])
        return o.join('')
    }
    function he(e) {
        var t
        ce || le()
        for (var n = e.length, r = n % 3, a = '', o = [], i = 0, u = n - r; i < u; i += 16383)
            o.push(de(e, i, i + 16383 > u ? u : i + 16383))
        return (
            1 === r
                ? ((t = e[n - 1]), (a += ue[t >> 2]), (a += ue[(t << 4) & 63]), (a += '=='))
                : 2 === r &&
                  ((t = (e[n - 2] << 8) + e[n - 1]),
                  (a += ue[t >> 10]),
                  (a += ue[(t >> 4) & 63]),
            ...
            t = Math.abs(t),
                isNaN(t) || t === 1 / 0
                    ...
                    : ((i = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += i + l >= 1 ? d / s : d * Math.pow(2, 1 - l)) * s >= 2 && (i++, (s /= 2)),
                      i + l >= c
                          ? ((u = 0), (i = c))
                          : i + l >= 1
            ...
            : (function(e, t) {
                  ...
                  if (t) {
                      if (('undefined' != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer) || 'length' in t)
                          return 'number' != typeof t.length || (r = t.length) != r ? _e(e, 0) : Me(e, t)
    ...
    function Se(e) {
        if (e >= ye())
            throw new RangeError(
                'Attempt to allocate Buffer larger than maximum size: 0x' + ye().toString(16) + ' bytes'
            )
        return 0 | e
    }
    function Ae(e) {
    ...
    function Le(e, t, n, r, a) {
        ...
        if ('number' == typeof t)
            return (
                (t &= 255),
                be.TYPED_ARRAY_SUPPORT && 'function' == typeof Uint8Array.prototype.indexOf
                    ? a
                    ...
                    case 4:
                        ;(o = e[a + 1]),
                            ...
                            128 == (192 & o) &&
                                128 == (192 & i) &&
                                128 == (192 & u) &&
                                (s = ((15 & f) << 18) | ((63 & o) << 12) | ((63 & i) << 6) | (63 & u)) > 65535 &&
                                s < 1114112 &&
                                (c = s)
                }
            null === c
    ...
    ;(be.TYPED_ARRAY_SUPPORT = void 0 === ie.TYPED_ARRAY_SUPPORT || ie.TYPED_ARRAY_SUPPORT),
        (be.poolSize = 8192),
        ...
        (be.prototype.swap64 = function() {
            ...
            for (var t = 0; t < e; t += 8)
                Te(this, t, t + 7), Te(this, t + 1, t + 6), Te(this, t + 2, t + 5), Te(this, t + 3, t + 4)
            return this
        }),
        ...
        (be.prototype.compare = function(e, t, n, r, a) {
            ...
            for (
                var o = a - r, i = n - t, u = Math.min(o, i), s = this.slice(r, a), f = e.slice(t, n), c = 0;
                c < u;
                ++c
            )
                if (s[c] !== f[c]) {
    ...
    ;(be.prototype.slice = function(e, t) {
        ...
        (be.prototype.writeUInt16LE = function(e, t, n) {
            return (
                ...
                be.TYPED_ARRAY_SUPPORT ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8)) : $e(this, e, t, !0),
                t + 2
            )
        }),
        (be.prototype.writeUInt16BE = function(e, t, n) {
            return (
                ...
                (t |= 0),
                n || Ke(this, e, t, 2, 65535, 0),
                be.TYPED_ARRAY_SUPPORT ? ((this[t] = e >>> 8), (this[t + 1] = 255 & e)) : $e(this, e, t, !1),
                t + 2
            )
        }),
        ...
        (be.prototype.copy = function(e, t, n, r) {
            ...
            else if (o < 1e3 || !be.TYPED_ARRAY_SUPPORT) for (a = 0; a < o; ++a) e[a + t] = this[a + n]
    ...
    function et(e) {
        return (function(e) {
            ...
            return (
                2 === o
                    ? ((a = (se[e.charCodeAt(t)] << 2) | (se[e.charCodeAt(t + 1)] >> 4)), (i[s++] = 255 & a))
                    : 1 === o &&
                      ((a =
        ...
        var n = {
            ...
            stringify: function(e, t, r) {
                var a,
                    ...
                    u = e.value
                if (
                    ((a = u instanceof be ? u.toString('base64') : be.from(u.buffer).toString('base64')),
                    ...
                    for (
                        var s = n.options.lineWidth, f = Math.ceil(a.length / s), c = new Array(f), l = 0, d = 0;
                        l < f;
                        ++l, d += s
                    )
                        c[l] = a.substr(d, s)
    ...
    var ot = r(function(e, t) {
        Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = t.boolOptions = t.nullOptions = void 0)
        var n = o(rt),
            r = o(at),
            a = o(re)
        function o(e) {
    ...
    var it = r(function(e, t) {
        ...
        var g = { core: s.default, failsafe: f.default, json: c.default, 'yaml-1.1': p.default }
        t.availableSchema = g
        t.defaultPrefix = 'tag:yaml.org,2002:'
        var m = { MAP: 'tag:yaml.org,2002:map', SEQ: 'tag:yaml.org,2002:seq', STR: 'tag:yaml.org,2002:str' }
        t.DefaultTags = m
        var y = (function() {
            function e(t) {
                var n = t.merge,
                        ...
                        value: function(e, t, n) {
                            ...
                            if (o) {
                                e.warnings.push(
                                    new S.YAMLWarning(
                                        t,
                                        'The tag '.concat(n, ' is unavailable, falling back to ').concat(o)
                                    )
                                )
                            ...
                            return (
                                e.errors.push(new S.YAMLReferenceError(t, 'The tag '.concat(n, ' is unavailable'))),
                                null
                            )
                        },
                    },
                ...
                return (
                    u(e, [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                this.schema ||
                                    (this.schema = new i.default(Object.assign({}, this.getDefaults(), this.options)))
                            },
                        },
                        {
                            key: 'parse',
                            value: function(e) {
                                ...
                                switch (
                                    ...
                                    default:
                                        ;(this.contents = l),
                                            this.contents[0]
                                                ? (this.contents[0].commentBefore = c.before.join('\n') || null)
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                if (n && r)
                                    ...
                                    this.errors.push(
                                        new S.YAMLSemanticError(e, 'Insufficient parameters given for %TAG directive')
                                    )
                                }
                            },
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                if (n) {
                                    ...
                                    this.errors.push(
                                        new S.YAMLSemanticError(t, 'Insufficient parameters given for %YAML directive')
                                    )
                                }
                            },
                        },
                                ...
                                if (t) {
                                    ...
                                    if (u) {
                                        ...
                                        if (f) {
                                            ...
                                            this.errors.push(
                                                new S.YAMLSemanticError(e, 'The '.concat(a, ' tag has no suffix.'))
                                            )
                                        } else {
                            ...
                            value: function(e) {
                                ...
                                if (
                                    (((function(e) {
                                        return (
                                            e &&
                                            -1 !== [M.Type.MAP_KEY, M.Type.MAP_VALUE, M.Type.SEQ_ITEM].indexOf(e.type)
                                        )
                                    })(e.context.parent)
                                        ...
                                        switch (e.context.src[a]) {
                                            ...
                                            case M.Char.ANCHOR:
                                                if (o) {
                                                    r.push(
                                                        new S.YAMLSemanticError(e, 'A node can have at most one anchor')
                                                    )
                                                }
                                                o = !0
                                                break
                                            case M.Char.TAG:
                                                if (i) {
                                                    r.push(
                                                        new S.YAMLSemanticError(e, 'A node can have at most one tag')
                                                    )
                                                }
                                                i = !0
                                        }
                                ...
                                if (e.type === M.Type.ALIAS) {
                                    if (o || i) {
                                        r.push(
                                            new S.YAMLSemanticError(e, 'An alias node must not specify any properties')
                                        )
                                    }
                                    var l = e.rawValue,
                                        d = n.getNode(l)
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                var n =
                                    ...
                                    ('string' != typeof e || !(this.contents instanceof l.default))
        ...
        ;(t.default = m),
            ...
            (g = {
                ...
                1.1: {
                    schema: 'yaml-1.1',
                    merge: !0,
                    tagPrefixes: [{ handle: '!', prefix: '!' }, { handle: '!!', prefix: i.defaultPrefix }],
                },
                1.2: {
                    schema: 'core',
                    merge: !1,
            ...
            v in p
                ? Object.defineProperty(p, v, { value: g, enumerable: !0, configurable: !0, writable: !0 })
                : (p[v] = g),
            (e.exports = t.default),
            (e.exports.default = t.default)
    })
    ...
    var st = r(function(e, t) {
        ...
        var u = { keepNodeTypes: !0, keepBlobsInJSON: !0, tags: null, version: '1.2' },
            c = (function(e) {
                function t(e) {
            ...
            switch (e.type) {
                ...
                case 'mappingValue':
                    return (
                        ...
                        ('mappingValue' === e.type || e.position.start.offset !== e.children[0].position.start.offset)
                    )
                default:
                    return !1
            }
                        ...
                        !(function(e, t, r) {
                            ...
                            if (o) {
                                if (o.trailingComment)
                                    throw new Error(
                                        'Unexpected multiple trailing comment at ' + ct.getPointText(e.position.start)
                                    )
    ...
    var ht = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createRoot = function(e, t, n) {
                return w.__assign({}, dt.createNode('root', e), { children: t, comments: n })
            })
    })
    n(ht)
    ...
    var mt = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createAlias = function(e, t, n) {
                return w.__assign({}, dt.createNode('alias', e), gt.createCommentAttachable(), t, { value: n })
            })
    })
    n(mt)
        ...
        ;(t.__esModule = !0),
            (t.transformAlias = function(e, t) {
                ...
                return mt.createAlias(
                    t.transformRange({ origStart: n.valueRange.origStart - 1, origEnd: n.valueRange.origEnd }),
            ...
            (t.transformAstBlockValue = function(e, t) {
                var r = e.cstNode,
                    ...
                    s = At.transformContent(e, t, function(e) {
                        if (!(i.start.offset < e.position.start.offset && e.position.end.offset < i.end.offset))
                            return !1
                        if (u)
                            throw new Error(
                                'Unexpected multiple indicator comments at ' + ct.getPointText(e.position.start)
                            )
                        return (u = e), !0
                    })
            ...
            (t.extractPropComments = function(e, t) {
                for (var n = 0, r = e.props; n < r.length; n++) {
                    ...
                    switch (o) {
                        case wt.PropLeadingCharacter.Comment:
                            t.comments.push(
                                Et.createComment(t.transformRange(a), t.text.slice(a.origStart + 1, a.origEnd))
                            )
                            break
                        default:
            ...
            (t.transformDocumentBody = function(e, t, n) {
                var r,
                    ...
                    l = (function(e, t, n) {
                        ...
                        '\r' === n.text[a - 1] && a--
                        var o = n.transformRange({ origStart: null !== t ? t.position.start.offset : a, origEnd: a }),
                ...
                var n,
                    ...
                    s = (function(e, t, n) {
                        ...
                        return (
                            ...
                            { position: n.transformRange(a), endMarkerPoint: -1 === r ? null : n.transformOffset(r) }
                        )
                    })(r, o, t),
                    f = s.position,
                    c = s.endMarkerPoint
    ...
    var $t = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createFlowMapping = function(e, t, n) {
                return w.__assign({}, Kt.createFlowCollection(e, t, n), { type: 'flowMapping' })
            })
    })
    n($t)
    var qt = r(function(e, t) {
        ...
        ;(t.__esModule = !0),
            (t.transformAstPair = function(e, t, n, r, a) {
                var o = t.transformNode(e.key),
                    i = t.transformNode(
                        'MERGE_PAIR' === e.type ? (e.value.type ? e.value : e.value.items[0]) : e.value
                    ),
                    u =
                        o || r
                            ? Zt.createMappingKey(
                    ...
                    s =
                        i || a
                            ...
                            : null
                return n(
                    Dt.createPosition(u ? u.position.start : s.position.start, s ? s.position.end : u.position.end),
                    u || Zt.createMappingKey(Dt.createEmptyPosition(s.position.start), null),
                    s || Xt.createMappingValue(Dt.createEmptyPosition(u.position.end), null)
                )
            })
    })
    n(en)
        ...
        ;(t.__esModule = !0),
            (t.transformFlowMap = function(e, t) {
                ...
                return $t.createFlowMapping(
                    t.transformRange({ origStart: o.origOffset, origEnd: i.origOffset + 1 }),
                    t.transformContent(e),
                    a
                )
            })
    ...
    var nn = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createFlowSequence = function(e, t, n) {
                return w.__assign({}, Kt.createFlowCollection(e, t, n), { type: 'flowSequence' })
            })
    })
    n(nn)
    var rn = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createFlowSequenceItem = function(e, t) {
                return w.__assign({}, dt.createNode('flowSequenceItem', e), { children: [t] })
            })
    })
    n(rn)
    ...
    var fn = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createPlain = function(e, t, n) {
                return w.__assign({}, dt.createNode('plain', e), gt.createCommentAttachable(), t, { value: n })
            })
    })
    n(fn)
    ...
    var hn = r(function(e, t) {
        ;(t.__esModule = !0),
            (t.createQuoteValue = function(e, t, n) {
                return w.__assign({}, dt.createNode('quoteValue', e), t, gt.createCommentAttachable(), { value: n })
            })
    })
    n(hn)
                ...
                var n = Jt.extractComments(e.cstNode.items, t).map(function(n, r) {
                    ...
                    return _n.createSequenceItem(
                        Dt.createPosition(
                            ...
                            null === a ? t.transformOffset(n.valueRange.origStart + 1) : a.position.end
                        ),
                        a
                    )
                })
            ...
            (t.updatePositions = function e(t) {
                if (null !== t && 'children' in t) {
                    ...
                    'endComments' in t &&
                        ...
                        (d(t.endComments[0].position.start), h(Yt.getLast(t.endComments).position.end))
                    ...
                    if (0 !== p.length) {
                        ...
                        d(v.position.start),
                            ...
                            'trailingComment' in g && g.trailingComment && h(g.trailingComment.position.end)
                    }
                }
            })
    })
