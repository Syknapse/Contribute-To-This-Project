!(function(t, e) {
    ...
    function h(t, e) {
        ...
        return (
            ...
            { type: 'PathExpression', original: t, this: a, parts: r, data: !1, loc: v(e || null) }
        )
    }
    function p(t, e, r) {
    ...
    var g = { source: '(synthetic)', start: { line: 1, column: 0 }, end: { line: 1, column: 0 } }
    function v() {
        for (var t = arguments.length, r = new Array(t), a = 0; a < t; a++) r[a] = arguments[a]
        if (1 === r.length) {
            var n = r[0]
            return n && 'object' === e(n)
                ? { source: d(n.source), start: m(n.start.line, n.start.column), end: m(n.end.line, n.end.column) }
                : g
        }
        var i = r[0],
            s = r[1],
    ...
    var y = {
        ...
        sexpr: function(t, e, r, a) {
            return { type: 'SubExpression', path: h(t), params: e || [], hash: r || f([]), loc: v(a || null) }
        },
        path: h,
        concat: function(t, e) {
        ...
        program: function(t, e, r) {
            return { type: 'Program', body: t || [], blockParams: e || [], loc: v(r || null) }
        },
        loc: v,
        pos: m,
        ...
        var e = (function(t) {
            ...
            if (-1 !== n && e > n && '|' === r[n + 1].charAt(0)) {
                ...
                for (var s = [], o = n + 1; o < e; o++) {
                    ...
                    if ('' !== l) {
                        if (w.test(l))
                            throw new S("Invalid identifier for block parameters: '" + l + "' in '" + i + "'", t.loc)
                        s.push(l)
                    }
                }
        ...
        function t(t, e) {
            ;(this.delegate = t),
                ...
                (this.states = {
                    beforeData: function() {
                        var t = this.peek()
                        if ('<' === t) this.transitionTo('tagOpen'), this.markTagStart(), this.consume()
                        else {
                            if ('\n' === t) {
                    ...
                    attributeName: function() {
                        ...
                        O(t)
                            ...
                            : '"' === t || "'" === t || '<' === t
                            ? (this.delegate.reportSyntaxError(t + ' is not a valid character within attribute names'),
                              this.consume(),
                              this.delegate.appendToAttributeName(t))
        ...
        switch (t.type) {
            ...
            case 'ElementNode':
                a.push('<', t.tag),
                    ...
                    re[t.tag]
                        ...
                        : (a.push('>'), a.push.apply(a, pt(t.children)), a.push('</', t.tag, '>'))
                break
            case 'AttrNode':
            ...
            case 'BlockStatement':
                ...
                t.chained
                    ...
                    s.push(ht(t.program)),
                    t.inverse && (t.inverse.chained || s.push('{{else}}'), s.push(ht(t.inverse))),
                    t.chained ||
                        s.push(
                            (function(t) {
    ...
    var St = yt(function(t, e) {
        ...
        function a(t, e) {
            ...
            for (var o = Error.prototype.constructor.call(this, t), l = 0; l < r.length; l++) this[r[l]] = o[r[l]]
            ...
            (e.default = function(t) {
                t.registerHelper('blockHelperMissing', function(e, r) {
                    ...
                    if (r.data && r.ids) {
                        ...
                        ;(i.contextPath = kt.appendContextPath(r.data.contextPath, r.name)), (r = { data: i })
                    }
                    return n(e, r)
                })
            }),
    ...
    var xt = yt(function(t, r) {
        ...
        ;(r.default = function(t) {
            t.registerHelper('each', function(t, r) {
                ...
                function u(e, r, n) {
                    l &&
                        ((l.key = e), (l.index = r), (l.first = 0 === r), (l.last = !!n), c && (l.contextPath = c + e)),
                        (o += a(t[e], { data: l, blockParams: kt.blockParams([t[e], e], [c + e, null]) }))
                }
                if (
                    (r.data && r.ids && (c = kt.appendContextPath(r.data.contextPath, r.ids[0]) + '.'),
                    kt.isFunction(t) && (t = t.call(this)),
                    r.data && (l = kt.createFrame(r.data)),
                    t && 'object' === e(t))
                )
                    if (kt.isArray(t)) for (var h = t.length; s < h; s++) s in t && u(s, s, s === t.length - 1)
                    else {
                        var p = void 0
        ...
        ;(e.__esModule = !0),
            (e.default = function(t) {
                t.registerHelper('if', function(t, e) {
                    return (
                        kt.isFunction(t) && (t = t.call(this)),
                        (!e.hash.includeZero && !t) || kt.isEmpty(t) ? e.inverse(this) : e.fn(this)
                    )
                }),
            ...
            (e.default = function(t) {
                t.registerHelper('with', function(t, e) {
                    ...
                    return (
                        ...
                        r(t, { data: a, blockParams: kt.blockParams([t], [a && a.contextPath]) })
                    )
                })
            }),
            (t.exports = e.default)
    ...
    var qt = yt(function(t, e) {
        ...
        i.prototype = {
            ...
            registerPartial: function(t, e) {
                if ('[object Object]' === kt.toString.call(t)) kt.extend(this.partials, t)
                else {
                    if (void 0 === e)
            ...
            (r.template = function(t, r) {
                ...
                var a = {
                    ...
                    invokePartial: function(e, a, s) {
                        ...
                        null == o &&
                            r.compile &&
                            ((s.partials[s.name] = r.compile(e, t.compilerOptions, r)), (o = s.partials[s.name](a, s)))
                        if (null != o) {
                            if (s.indent) {
                ...
                function o(e) {
                    ...
                    return (
                        t.useDepths && (i = r.depths ? (e != r.depths[0] ? [e].concat(r.depths) : r.depths) : [e]),
                    ...
                    (o._setup = function(e) {
                        e.partial
                            ...
                            : ((a.helpers = a.merge(e.helpers, r.helpers)),
                              ...
                              (t.usePartial || t.useDecorators) && (a.decorators = a.merge(e.decorators, r.decorators)))
                    }),
                    ...
                    performAction: function(t, e, r, a, n, i, s) {
                        ...
                        switch (n) {
                            ...
                            case 30:
                                ...
                                break
                            case 31:
                                this.$ = { type: 'HashPair', key: a.id(i[o - 2]), value: i[o], loc: a.locInfo(this._$) }
                                break
                            case 32:
                                this.$ = a.id(i[o - 1])
                                break
                            ...
                            case 34:
                                ...
                                break
                            case 35:
                                this.$ = { type: 'StringLiteral', value: i[o], original: i[o], loc: a.locInfo(this._$) }
                                break
                            case 36:
                                this.$ = {
                                    type: 'NumberLiteral',
        ...
        ;(n.prototype = new a.default()),
            ...
            (n.prototype.BlockStatement = n.prototype.DecoratorBlock = n.prototype.PartialBlockStatement = function(t) {
                ...
                var e = t.program || t.inverse,
                    ...
                    a = r,
                    n = r
                if (r && r.chained) for (a = r.body[0].program; n.chained; ) n = n.body[n.body.length - 1].program
                var c = {
        ...
        ;(e.__esModule = !0),
            ...
            (e.preparePath = function(t, e, r) {
                ...
                for (var n = t ? '@' : '', i = [], s = 0, o = 0, l = e.length; o < l; o++) {
                    var c = e[o].part,
                        u = e[o].original !== c
                    if (((n += (e[o].separator || '') + c), u || ('..' !== c && '.' !== c && 'this' !== c))) i.push(c)
                    else {
            ...
            helperSexpr: function(t, e, r) {
                ...
                if (this.options.knownHelpers[o]) this.opcode('invokeKnownHelper', i.length, o)
                    ...
                    if (this.options.knownHelpersOnly)
                        throw new a.default('You specified knownHelpersOnly, but used the unknown helper ' + o, t)
                    ;(s.strict = !0),
                        (s.falsy = !0),
                        this.accept(s),
        ...
        r ||
            ...
            (i.prototype = {
                ...
                generateList: function(t) {
                    for (var e = this.empty(), r = 0, a = t.length; r < a; r++) r && e.add(','), e.add(n(t[r], this))
                    return e
                },
        ...
        ;(s.prototype = {
            nameLookup: function(t, e) {
                return 'constructor' === e
                    ? ['(', t, ".propertyIsEnumerable('constructor') ? ", t, '.constructor : undefined', ')']
                ...
                return (
                    ...
                    n
                        ...
                        : ((h.compiler = JSON.stringify(h.compiler)),
                          ...
                          e.srcName
                              ? ((h = h.toStringWithSourceMap({ file: e.destName })).map = h.map && h.map.toString())
                              : (h = h.toString())),
                    h
                )
            },
            ...
            invokeAmbiguous: function(t, e) {
                ...
                this.options.strict ||
                    ((n[0] = '(helper = '), n.push(' != null ? helper : ', this.aliasable('helpers.helperMissing'))),
                    this.push([
                        '(',
                        n,
            ...
            pushId: function(t, e, r) {
                'BlockParam' === t
                    ? this.pushStackLiteral(
                          'blockParams[' + e[0] + '].path[' + e[1] + ']' + (r ? ' + ' + JSON.stringify('.' + r) : '')
                      )
                    : 'PathExpression' === t
                    ? this.pushString(e)
                    : 'SubExpression' === t
            ...
            aliasable: function(t) {
                ...
                return e
                    ? (e.referenceCount++, e)
                    : (((e = this.aliases[t] = this.source.wrap(t)).aliasable = !0), (e.referenceCount = 1), e)
            },
            ...
            setupHelperArgs: function(t, e, r, a) {
                ...
                return (
                    (n = this.objectLiteral(n)),
                    a ? (this.useRegister('options'), r.push('options'), ['options=', n]) : r ? (r.push(n), '') : n
                )
            },
        }),
            (function() {
        ...
        ;(n.prototype = new a.default()),
            ...
            (n.prototype.BlockStatement = n.prototype.DecoratorBlock = function(t) {
                ...
                return (
                    ...
                    t.program &&
                        ((e += this.pad('PROGRAM:')), this.padding++, (e += this.accept(t.program)), this.padding--),
                    t.inverse &&
    ...
    'undefined' != typeof require &&
        require.extensions &&
        ((require.extensions['.handlebars'] = te), (require.extensions['.hbs'] = te))
    var ee = Xt.parse,
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        ;(a.loc = y.loc(this.tagOpenLine, this.tagOpenColumn, e, r)),
                            'StartTag' === a.type
                                ? (this.finishStartTag(), (re[a.name] || a.selfClosing) && this.finishEndTag(!0))
    ...
    function se(t, r) {
        ...
        if (r && r.plugins && r.plugins.ast)
            for (var s = 0, o = r.plugins.ast.length; s < o; s++) {
                at(i, (0, r.plugins.ast[s])(V({}, r, { syntax: ie }, { plugins: void 0 })).visitor)
            }
        return i
    }
    ...
    function ce(t) {
        return (
            'TextNode' !== t.type || ('TextNode' === t.type && '' !== t.chars.replace(/^\s+/, '').replace(/\s+$/, ''))
        )
    }
    function ue() {
        return {
            ...
            glimmer: {
                parse: function(e) {
                    try {
                        ...
                        throw r ? t(e.message, { start: { line: Number(r[1]), column: 0 } }) : e
                    }
                },
                astFormat: 'glimmer',
                locStart: function(t) {
