...
var winParseTests = [
    [
        { root: 'C:\\', dir: 'C:\\path\\dir', base: 'index.html', ext: '.html', name: 'index' },
        'C:\\path\\dir\\index.html',
    ],
    [
        { root: 'C:\\', dir: 'C:\\another_path\\DIR\\1\\2\\33', base: 'index', ext: '', name: 'index' },
        'C:\\another_path\\DIR\\1\\2\\33\\index',
    ],
    [
        { root: '', dir: 'another_path\\DIR with spaces\\1\\2\\33', base: 'index', ext: '', name: 'index' },
    ...
    // unc
    [
        { root: '\\\\server\\share\\', dir: '\\\\server\\share\\', base: 'file_path', ext: '', name: 'file_path' },
    ...
    [
        { root: '\\\\teela\\admin$\\', dir: '\\\\teela\\admin$\\', base: 'system32', ext: '', name: 'system32' },
        '\\\\teela\\admin$\\system32',
    ],
    [
        { root: '\\\\?\\UNC\\', dir: '\\\\?\\UNC\\server', base: 'share', ext: '', name: 'share' },
        '\\\\?\\UNC\\server\\share',
    ],
]
...
var unixParseTests = [
    ...
    [
        { root: '/', dir: '/home/user/a dir', base: 'another File.zip', ext: '.zip', name: 'another File' },
        '/home/user/a dir/another File.zip',
    ],
    [
        { root: '/', dir: '/home/user/a dir/', base: 'another&File.', ext: '.', name: 'another&File' },
    ...
    [
        { root: '', dir: 'user/dir', base: 'another File.zip', ext: '.zip', name: 'another File' },
