**Announcement** you can support the development of v4 major release on [**Open Collective**](https://opencollective.com/husky) and [**GitHub Sponsors**](https://github.com/users/typicode/sponsorship) 🚀
...
**Note**: if you're trying Yarn v2, please install `husky@next`. See [next](https://github.com/typicode/husky/tree/next) branch.
