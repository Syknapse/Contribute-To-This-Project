    ...
    fixBugsField: function(data) {
        if (!data.bugs && data.repository && data.repository.url) {
            ...
            if (typeof data.bugs == 'string') {
                ...
                data.bugs = {}
                if (oldBugs.url) {
                    if (typeof oldBugs.url == 'string' && url.parse(oldBugs.url).protocol) data.bugs.url = oldBugs.url
                    else this.warn('nonUrlBugsUrlField')
                }
                if (oldBugs.email) {
                    if (typeof oldBugs.email == 'string' && emailRe.test(oldBugs.email)) data.bugs.email = oldBugs.email
